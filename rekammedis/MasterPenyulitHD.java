 ...
 * @author dosen
 */
public class MasterPenyulitHD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterPenyulitHD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Penyulit Hemodialisa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.textKosong(TNm,"Penyulit");
        }else{
            if(Sequel.menyimpantf("master_penyulit_hd","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_penyulit_hd","kode_penyulit")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_penyulit_hd","kode_penyulit=?","kode_penyulit=?,nama_penyulit=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterPenyulitHD dialog = new MasterPenyulitHD(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_penyulit_hd where master_penyulit_hd.kode_penyulit like ? or master_penyulit_hd.nama_penyulit like ? order by master_penyulit_hd.kode_penyulit");
            try {
