...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2024 08:06:44" }));
    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "kamar_inap.diagnosa_awal,kamar_inap.kd_kamar,bangsal.nm_bangsal,kamar_inap.tgl_masuk,kamar_inap.jam_masuk from reg_periksa "+
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    Masuk.setText(rs.getString("tgl_masuk"));
