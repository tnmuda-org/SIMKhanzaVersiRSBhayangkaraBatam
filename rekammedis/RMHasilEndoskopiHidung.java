...
public final class RMHasilEndoskopiHidung extends javax.swing.JDialog {
    ...
    public RMHasilEndoskopiHidung(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Kavum Nasi","Konka Inferior","Secret","Meatus Medius","Konka Media","Septum","Nasofaring","Kesimpulan"
        }){
...
//        LoadHTML2.setDocument(doc);
    ...
    private void initComponents() {
        ...
        Kavum_nasi = new widget.ComboBox();
        jLabel42 = new widget.Label();
        Konka_inferior = new widget.ComboBox();
        jLabel43 = new widget.Label();
        Secret = new widget.ComboBox();
        jLabel44 = new widget.Label();
        Meatus_medius = new widget.ComboBox();
        jLabel46 = new widget.Label();
        Konka_media = new widget.ComboBox();
        jLabel47 = new widget.Label();
        Septum = new widget.ComboBox();
        jLabel48 = new widget.Label();
        Nasofaring = new widget.ComboBox();
        ...
        MnPenilaianMedis.setText("Formulir Hasil Endoskopi Hidung");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Endoskopi Hidung ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-11-2023 08:25:24" }));
        ...
        jLabel41.setText("Kavum Nasi :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 120, 150, 23);

        Kavum_nasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lapang", "Sempit" }));
        Kavum_nasi.setName("Kavum_nasi"); // NOI18N
        Kavum_nasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Kavum_nasiActionPerformed(evt);
            }
        });
        Kavum_nasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Kavum_nasiKeyPressed(evt);
            }
        });
        FormInput.add(Kavum_nasi);
        Kavum_nasi.setBounds(160, 120, 150, 23);

        jLabel42.setText("Konka Inferior :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 150, 150, 23);

        Konka_inferior.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Eutrofi", "Hipertrofi", "Oedem", "Livid" }));
        Konka_inferior.setName("Konka_inferior"); // NOI18N
        Konka_inferior.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Konka_inferiorActionPerformed(evt);
            }
        });
        Konka_inferior.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Konka_inferiorKeyPressed(evt);
            }
        });
        FormInput.add(Konka_inferior);
        Konka_inferior.setBounds(160, 150, 150, 23);
        ...
        Secret.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Serous", "Seromukoid" }));
        Secret.setName("Secret"); // NOI18N
        ...
        FormInput.add(Secret);
        Secret.setBounds(160, 180, 150, 23);

        jLabel44.setText("Meatus Medius :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 210, 150, 23);

        Meatus_medius.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Terbuka", "Tertutup" }));
        Meatus_medius.setName("Meatus_medius"); // NOI18N
        Meatus_medius.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Meatus_mediusActionPerformed(evt);
            }
        });
        Meatus_medius.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Meatus_mediusKeyPressed(evt);
            }
        });
        FormInput.add(Meatus_medius);
        Meatus_medius.setBounds(160, 210, 150, 23);

        jLabel46.setText("Konka Media :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(350, 120, 150, 23);

        Konka_media.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Bulosa", "Paradox" }));
        Konka_media.setName("Konka_media"); // NOI18N
        Konka_media.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Konka_mediaActionPerformed(evt);
            }
        });
        Konka_media.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Konka_mediaKeyPressed(evt);
            }
        });
        FormInput.add(Konka_media);
        Konka_media.setBounds(510, 120, 150, 23);
        ...
        Septum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lurus", "Deviasi" }));
        Septum.setName("Septum"); // NOI18N
        Septum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SeptumActionPerformed(evt);
            }
        });
        Septum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SeptumKeyPressed(evt);
            }
        });
        FormInput.add(Septum);
        Septum.setBounds(510, 150, 150, 23);
        ...
        Nasofaring.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Massa", "Post Nasal Drip" }));
        Nasofaring.setName("Nasofaring"); // NOI18N
        Nasofaring.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NasofaringActionPerformed(evt);
            }
        });
        Nasofaring.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NasofaringKeyPressed(evt);
            }
        });
        FormInput.add(Nasofaring);
        Nasofaring.setBounds(510, 180, 150, 23);
        ...
        TabRawat.addTab("Input Hasil Endoskopi Hidung", internalFrame2);
        ...
        TabRawat.addTab("Data Hasil Endoskopi Hidung", internalFrame3);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("hasil_endoskopi_hidung","?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",12,new String[]{
                    TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                    Diagnosis.getText(),Kavum_nasi.getSelectedItem().toString(),Konka_inferior.getSelectedItem().toString(),
                    Secret.getSelectedItem().toString(),Meatus_medius.getSelectedItem().toString(),
                    Konka_media.getSelectedItem().toString(),Septum.getSelectedItem().toString(),Nasofaring.getSelectedItem().toString(),Kesimpulan.getText()
...
//                tampilOrthanc();
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanEndosHidung.jasper","report","::[ Formulir Hasil Endoskopi Hidung ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_endoskopi_hidung.tanggal,"+
                "hasil_endoskopi_hidung.kd_dokter,dokter.nm_dokter,hasil_endoskopi_hidung.diagnosis,"+
                "hasil_endoskopi_hidung.kavum_nasi,hasil_endoskopi_hidung.konka_inferior,hasil_endoskopi_hidung.sekret,"+
                "hasil_endoskopi_hidung.meatus_medius,hasil_endoskopi_hidung.konka_media,hasil_endoskopi_hidung.septum,"+
                "hasil_endoskopi_hidung.nasofaring,"+
                "hasil_endoskopi_hidung.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
    ...
    private void Kavum_nasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Kavum_nasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kavum_nasiActionPerformed

    private void Kavum_nasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Kavum_nasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Kavum_nasiKeyPressed

    private void Konka_inferiorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Konka_inferiorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Konka_inferiorActionPerformed

    private void Konka_inferiorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Konka_inferiorKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Konka_inferiorKeyPressed
    ...
    private void Meatus_mediusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Meatus_mediusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Meatus_mediusActionPerformed

    private void Meatus_mediusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Meatus_mediusKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Meatus_mediusKeyPressed

    private void Konka_mediaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Konka_mediaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Konka_mediaActionPerformed

    private void Konka_mediaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Konka_mediaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Konka_mediaKeyPressed

    private void SeptumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SeptumActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SeptumActionPerformed

    private void SeptumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SeptumKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_SeptumKeyPressed

    private void NasofaringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NasofaringActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NasofaringActionPerformed

    private void NasofaringKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NasofaringKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NasofaringKeyPressed
...
//        Valid.pindah2(evt,Kista,BtnSimpan);
    ...
    */
    ...
    private widget.ComboBox Kavum_nasi;
    private widget.TextBox KdDokter;
    private widget.TextArea Kesimpulan;
    private widget.ComboBox Konka_inferior;
    private widget.ComboBox Konka_media;
    private widget.Label LCount;
    private widget.editorpane LoadHTML;
    private widget.ComboBox Meatus_medius;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private widget.ComboBox Nasofaring;
    private widget.TextBox NmDokter;
    private widget.ScrollPane Scroll;
    private widget.ComboBox Secret;
    private widget.ComboBox Septum;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("diagnosis"),rs.getString("kavum_nasi"),rs.getString("konka_inferior"),rs.getString("sekret"),rs.getString("meatus_medius"),
                        rs.getString("konka_media"),rs.getString("septum"),rs.getString("nasofaring"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Kavum_nasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Konka_inferior.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Secret.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            Meatus_medius.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            Konka_media.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            Septum.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            Nasofaring.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
    ...
    private void ganti() {
          if(Sequel.mengedittf("hasil_endoskopi_hidung","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosis=?,kavum_nasi=?,konka_inferior=?,sekret=?,"+
                "meatus_medius=?,konka_media=?,septum=?,nasofaring=?,kesimpulan=?",13,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                Diagnosis.getText(),Kavum_nasi.getSelectedItem().toString(),Konka_inferior.getSelectedItem().toString(),
                Secret.getSelectedItem().toString(),Meatus_medius.getSelectedItem().toString(),Konka_media.getSelectedItem().toString(),
                Septum.getSelectedItem().toString(),Nasofaring.getSelectedItem().toString(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
