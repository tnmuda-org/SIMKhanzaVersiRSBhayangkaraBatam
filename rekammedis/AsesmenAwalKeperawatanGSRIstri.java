 ...
 * @author perpustakaan
 */
public final class AsesmenAwalKeperawatanGSRIstri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public AsesmenAwalKeperawatanGSRIstri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","J.K.","Kode Dokter","Nama Dokter","Tanggal","Keluhan Utama","Dismenorea","HPHT",
            "Polimenorea","Oligomenorea","Usia Menarche","Siklus Haid","Menometroragie","Durasi Haid","Amenorea","Istri","Warna Raba Vagina","Jumlah Rabas Vagina (cc)",
            "Berapa Lama Rabas Vagina","Methode KB","Lama KB","BAK (cc/Hari)","Warna BAK","BAB (x/Hari)","Karakteristik BAB","Tidur (Jam/Hari)","Luteinizing Hormone (LH)","Prolaktin",
            "Testosteron","HSG","Anti Mullerian Hormone (AMH)","Kesadaran","G-C-S","TB (cm)","BB (kg)","Suhu (c)","TD","Nadi",
            "RR","SpO2","Istri","Riwayat Penyakit","Riwayat Ginekologi","Riwayat Kontrasepsi","Komplikasi KB","Mata","Leher","Payudara",
            "Abdomen","Genitalia","Kandung Kemih","Ekstremitas","Hb","Ht","Leukosit","Trombosit","Glukosa","Urine",
            "Protein","Keton","Progesteron","Stimulating Hormone (FSH)","USG","Lain-Lain","Riwayat Persalinan","Tujuan/Target","Kode Perawat","Nama Perawat"
        }){
        ...
        BB1.setDocument(new batasInput((int)100).getKata(BB1));
        wita.setDocument(new batasInput((int)100).getKata(wita));
        jam1.setDocument(new batasInput((int)100).getKata(jam1));
        jam2.setDocument(new batasInput((int)100).getKata(jam2));
        jam3.setDocument(new batasInput((int)100).getKata(jam3));
        jam4.setDocument(new batasInput((int)100).getKata(jam4));
        mnt1.setDocument(new batasInput((int)100).getKata(mnt1));
        mnt2.setDocument(new batasInput((int)100).getKata(mnt2));
        mnt3.setDocument(new batasInput((int)100).getKata(mnt3));
        mnt4.setDocument(new batasInput((int)100).getKata(mnt4));
        darahan1.setDocument(new batasInput((int)100).getKata(darahan1));
        darahan2.setDocument(new batasInput((int)100).getKata(darahan2));
        darahan3.setDocument(new batasInput((int)100).getKata(darahan3));
        darahan4.setDocument(new batasInput((int)100).getKata(darahan4));
        ...
        Urine.setDocument(new batasInput((int)100).getKata(Urine));
        Protein.setDocument(new batasInput((int)100).getKata(Protein));
        Keton.setDocument(new batasInput((int)100).getKata(Keton));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Asesmen Keperawatan GSR (Istri) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel12.setBounds(560, 650, 30, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(590, 650, 45, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(640, 650, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(470, 650, 45, 23);

        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(440, 650, 30, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(390, 680, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(340, 680, 45, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(300, 680, 40, 23);

        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(660, 650, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(710, 650, 45, 23);

        jLabel22.setText("TD :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(20, 680, 127, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(150, 680, 76, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(760, 650, 30, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(230, 680, 50, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(520, 650, 30, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(550, 680, 50, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(500, 680, 45, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(460, 680, 40, 23);
        ...
        jLabel28.setBounds(290, 650, 70, 23);
        ...
        jLabel39.setBounds(80, 650, 70, 23);

        Ekstremitas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Edema" }));
        ...
        Ekstremitas.setBounds(390, 800, 130, 23);

        jLabel40.setText("Suami :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 360, 127, 23);
        ...
        Kesadaran.setBounds(150, 650, 130, 23);

        jLabel29.setText("SpO2 :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(610, 680, 40, 23);
        ...
        FormInput.add(SPO);
        SPO.setBounds(660, 680, 45, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("%");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(710, 680, 30, 23);

        Wajah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1x", "2x", ">2" }));
        ...
        FormInput.add(Wajah);
        Wajah.setBounds(130, 360, 100, 23);

        jLabel44.setText("Riwayat Persalinan :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 450, 127, 23);

        Mulut.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Infertilitas", "Infeksi Virus", "PMS", "Cervisitis Cronis", "Endometriosis", "Myoma", "Polip Servix", "Kanker Kandungan", "Operasi Kandungan", "Perkosaan", "Flour Albus", "Post Coital Bleeding", "PAP Smear" }));
        ...
        FormInput.add(Mulut);
        Mulut.setBounds(130, 420, 100, 23);

        jLabel45.setText("Riwayat Kontrasepsi :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(280, 180, 127, 23);

        Payudara.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        Payudara.setBounds(410, 180, 128, 23);

        jLabel46.setText("Komplikasi KB :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(280, 210, 127, 23);

        FundusUteri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Perdarahan", "PID / Radang Panggul", "Lain-Lain " }));
        ...
        FundusUteri.setBounds(410, 210, 128, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(50, 830, 95, 23);

        LukaOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada Benjolan", "TAK" }));
        ...
        LukaOperasi.setBounds(150, 800, 128, 23);

        jLabel50.setText("Genitalia :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(290, 740, 95, 23);

        Lokhea.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pembesaran Perut", "Luka Bekas Operasi", "Tumor", "Nyeri Tekan", "TAK" }));
        ...
        Lokhea.setBounds(150, 830, 128, 23);

        jLabel51.setText("Kandung Kemih :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(290, 770, 95, 23);

        LukaPerineum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Keputihan", "Darah", "Flour Albus", "Lain-lain", "TAK" }));
        ...
        LukaPerineum.setBounds(390, 740, 128, 23);

        FoleyCatheter.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Penuh", "Kosong" }));
        ...
        FoleyCatheter.setBounds(390, 770, 128, 23);
        ...
        scrollPane12.setBounds(360, 1460, 370, 120);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-07-2023 19:18:31" }));
        ...
        jLabel42.setText("Riawayat Penyakit :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 390, 127, 23);

        Mata.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Kanker", "Penyakit Hati", "Hipertensi", "DM", "Penyakit Ginjal", "Penyakit Jiwa", "Kelainan Bawaan", "Hamil Kembar", "TBC", "Epilepsi", "Alergi", "Kehamilan Ektopik", "Lain-Lain" }));
        ...
        FormInput.add(Mata);
        Mata.setBounds(130, 390, 100, 23);

        jLabel47.setText("Mata :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(20, 740, 127, 23);

        KontraksiUterus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Conjunctiva Merah", "Conjunctiva Pucat", "Sklera Ikteric", "Pandangan Kabur" }));
        ...
        KontraksiUterus.setBounds(150, 740, 128, 23);

        jLabel53.setText("Leher :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(50, 770, 95, 23);

        KandungKemih.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TVJ", "Pembesaran Kel. Tiroid " }));
        ...
        KandungKemih.setBounds(150, 770, 128, 23);
        ...
        jLabel43.setText("Dismenorea :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 180, 127, 23);

        JenisPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        JenisPersalinan.setBounds(130, 180, 100, 23);

        jLabel48.setText("Oligomenorea :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 240, 127, 23);
        ...
        JenisKelamin.setBounds(130, 240, 100, 23);

        jLabel54.setText("Menometroragie :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(0, 270, 127, 23);
        ...
        KetubanPecah.setBounds(130, 270, 100, 23);

        jLabel55.setText("Amenorea :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(0, 300, 127, 23);

        Episiotomi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        Episiotomi.setBounds(130, 300, 100, 23);

        jLabel56.setText("Polimenorea :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(0, 210, 127, 23);

        KeadaanAnak.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        KeadaanAnak.setBounds(130, 210, 100, 23);

        Pereneum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1x", "2x", ">2" }));
        ...
        Pereneum.setBounds(130, 330, 100, 23);
        ...
        FormInput.add(SCAI);
        SCAI.setBounds(700, 180, 160, 23);

        jLabel30.setText("HPHT :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(650, 180, 40, 23);

        jLabel14.setText("Usia Menarche :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(600, 210, 90, 23);
        ...
        FormInput.add(BB1);
        BB1.setBounds(700, 210, 80, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Hari");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(780, 270, 30, 23);

        jLabel31.setText("Siklus Haid :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(620, 240, 70, 23);
        ...
        FormInput.add(PB);
        PB.setBounds(700, 240, 80, 23);

        jLabel36.setText("Pola  Eliminasi / Istirahat");
        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(270, 300, 150, 23);
        ...
        FormInput.add(wita);
        wita.setBounds(700, 270, 80, 23);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("3. Pemeriksaan Penunjang");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(10, 870, 130, 23);

        jLabel60.setText("Warna :");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(650, 320, 40, 23);

        jLabel61.setText("Tidur :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(260, 390, 40, 23);

        jLabel62.setText("Karakteristik :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(400, 360, 70, 23);
        ...
        FormInput.add(jam1);
        jam1.setBounds(700, 320, 80, 23);

        jLabel65.setText("Berapa Lama :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(610, 380, 80, 23);
        ...
        FormInput.add(jam3);
        jam3.setBounds(485, 330, 60, 23);

        jLabel70.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel70.setText("x/Hari");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(360, 360, 30, 23);
        ...
        FormInput.add(jam4);
        jam4.setBounds(310, 390, 45, 23);

        jLabel71.setText("HSG :");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(390, 980, 40, 23);
        ...
        jamtotal.setBounds(320, 980, 45, 23);
        ...
        mnttotal.setBounds(440, 980, 45, 23);
        ...
        darahan1.setBounds(700, 380, 80, 23);

        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText("cc");
        jLabel75.setName("jLabel75"); // NOI18N
        FormInput.add(jLabel75);
        jLabel75.setBounds(780, 350, 30, 23);
        ...
        darahan2.setBounds(310, 330, 80, 23);

        jLabel76.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel76.setText("Warna :");
        jLabel76.setName("jLabel76"); // NOI18N
        FormInput.add(jLabel76);
        jLabel76.setBounds(440, 330, 40, 23);
        ...
        darahan3.setBounds(470, 360, 80, 23);
        ...
        darahan4.setBounds(180, 980, 45, 23);

        jLabel78.setText("Luteinizing Hormone (LH) :");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(590, 950, 140, 23);
        ...
        darahantotal.setBounds(740, 980, 45, 23);

        jLabel83.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel83.setText("1. Pemeriksaan Umum");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(20, 630, 127, 23);

        jLabel84.setText("Ekstremitas :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(290, 800, 95, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("2. Pemeriksaan Fisik");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(20, 710, 127, 23);

        jLabel41.setText("Hb :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(150, 890, 20, 23);

        jLabel86.setText("Ht :");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(290, 890, 20, 23);
        ...
        FormInput.add(USG);
        USG.setBounds(530, 950, 45, 23);

        jLabel88.setText("Leukosit :");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(380, 890, 50, 23);
        ...
        Leukosit.setBounds(440, 890, 45, 23);

        jLabel90.setText("Trombosit :");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(500, 890, 60, 23);
        ...
        Trombosit.setBounds(570, 890, 45, 23);

        jLabel91.setText("Glukosa :");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(120, 920, 50, 23);
        ...
        Glukosa.setBounds(180, 920, 45, 23);
        ...
        FormInput.add(Urine);
        Urine.setBounds(180, 950, 45, 23);

        jLabel92.setText("Prolaktin :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(120, 980, 50, 23);

        jLabel93.setText("Protein :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(260, 920, 50, 23);
        ...
        Protein.setBounds(320, 920, 45, 23);

        jLabel95.setText("Keton :");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(390, 920, 40, 23);
        ...
        FormInput.add(Ht);
        Ht.setBounds(320, 890, 45, 23);

        jLabel87.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel87.setText("Hormon");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(40, 950, 50, 23);
        ...
        Rontgen.setBounds(320, 950, 45, 23);
        ...
        label1.setBounds(360, 1440, 230, 20);
        ...
        scrollPane13.setBounds(30, 1040, 810, 43);
        ...
        scrollPane14.setBounds(30, 1120, 810, 43);
        ...
        scrollPane15.setBounds(130, 450, 730, 120);
        ...
        jLabel33.setText("Thn");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(780, 210, 30, 23);

        jLabel38.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel38.setText("Hari");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(780, 240, 30, 23);

        jLabel81.setText("Istri :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(0, 330, 127, 23);

        jLabel37.setText("Durasi Haid :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(600, 270, 90, 23);

        jLabel82.setText("Jumlah :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(640, 350, 50, 23);

        jLabel64.setText("Methode KB :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(280, 240, 127, 23);

        jLabel94.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel94.setText("Jam/Hari");
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(360, 390, 50, 23);

        jLabel98.setText("Lama KB :");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(280, 270, 127, 23);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel100.setText("cc/Hari");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(390, 330, 40, 23);

        jLabel59.setText("Rabas Pervagina");
        jLabel59.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(600, 300, 110, 23);

        jLabel66.setText("BAK :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(270, 330, 30, 23);

        jLabel67.setText("BAB :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(270, 360, 30, 23);

        jLabel68.setText("Payudara :");
        jLabel68.setName("jLabel68"); // NOI18N
        FormInput.add(jLabel68);
        jLabel68.setBounds(50, 800, 95, 23);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("USG");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(30, 1020, 180, 23);

        jLabel72.setText("Anti Mullerian Hormone (AMH) :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(570, 980, 160, 23);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("Darah");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(40, 890, 50, 23);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("Urine");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(40, 920, 50, 23);

        jLabel104.setText("Estradiol :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(120, 950, 50, 23);

        jLabel77.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel77.setText("Progesterone :");
        jLabel77.setName("jLabel77"); // NOI18N
        FormInput.add(jLabel77);
        jLabel77.setBounds(240, 950, 80, 23);

        jLabel80.setText("Stimulating Hormone (FSH) :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(370, 950, 150, 23);

        jLabel89.setText("Testosteron :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(230, 980, 80, 23);

        jLabel52.setText("Riwayat Ginekologi :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(0, 420, 127, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("asesmen_keperawatan_gsr_istri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","",65,new String[]{
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        ...
                        "asesmen_keperawatan_gsr_istri.tanggal,asesmen_keperawatan_gsr_istri.kd_dokter,asesmen_keperawatan_gsr_istri.keluhan_utama,asesmen_keperawatan_gsr_istri.jenis_persalinan,asesmen_keperawatan_gsr_istri.indikasi_sc,asesmen_keperawatan_gsr_istri.anak,asesmen_keperawatan_gsr_istri.jenis_kelamin,asesmen_keperawatan_gsr_istri.bb,asesmen_keperawatan_gsr_istri.pb,asesmen_keperawatan_gsr_istri.ketuban_pecah,"+
                        "asesmen_keperawatan_gsr_istri.jam_pecah,asesmen_keperawatan_gsr_istri.episiotomi,asesmen_keperawatan_gsr_istri.pereneum,asesmen_keperawatan_gsr_istri.jam_kala1,asesmen_keperawatan_gsr_istri.menit_kala1,asesmen_keperawatan_gsr_istri.darahan_kala1,asesmen_keperawatan_gsr_istri.jam_kala2,asesmen_keperawatan_gsr_istri.menit_kala2,asesmen_keperawatan_gsr_istri.darahan_kala2,asesmen_keperawatan_gsr_istri.jam_kala3,"+
                        "asesmen_keperawatan_gsr_istri.menit_kala3,asesmen_keperawatan_gsr_istri.darahan_kala3,asesmen_keperawatan_gsr_istri.jam_kala4,asesmen_keperawatan_gsr_istri.menit_kala4,asesmen_keperawatan_gsr_istri.darahan_kala4,asesmen_keperawatan_gsr_istri.kesadaran,asesmen_keperawatan_gsr_istri.gcs,asesmen_keperawatan_gsr_istri.tb,asesmen_keperawatan_gsr_istri.bb_umum,"+
                        "asesmen_keperawatan_gsr_istri.suhu,asesmen_keperawatan_gsr_istri.td,asesmen_keperawatan_gsr_istri.nadi,asesmen_keperawatan_gsr_istri.rr,asesmen_keperawatan_gsr_istri.spo2,asesmen_keperawatan_gsr_istri.wajah,asesmen_keperawatan_gsr_istri.mata,asesmen_keperawatan_gsr_istri.mulut,asesmen_keperawatan_gsr_istri.payudara,"+
                        "asesmen_keperawatan_gsr_istri.fundus_uteri,asesmen_keperawatan_gsr_istri.kontraksi_uterus,asesmen_keperawatan_gsr_istri.kandung_kemih,asesmen_keperawatan_gsr_istri.luka_operasi,asesmen_keperawatan_gsr_istri.lokhea,asesmen_keperawatan_gsr_istri.luka_perineum,asesmen_keperawatan_gsr_istri.foley_catheter,asesmen_keperawatan_gsr_istri.ekstremitas,asesmen_keperawatan_gsr_istri.hb,"+
                        "asesmen_keperawatan_gsr_istri.ht,asesmen_keperawatan_gsr_istri.leukosit,asesmen_keperawatan_gsr_istri.trombosit,asesmen_keperawatan_gsr_istri.glukosa,asesmen_keperawatan_gsr_istri.urine,asesmen_keperawatan_gsr_istri.protein,asesmen_keperawatan_gsr_istri.keton,asesmen_keperawatan_gsr_istri.rontgen,asesmen_keperawatan_gsr_istri.usg,"+
                        "asesmen_keperawatan_gsr_istri.analisa,asesmen_keperawatan_gsr_istri.penatalaksana,asesmen_keperawatan_gsr_istri.masalah,asesmen_keperawatan_gsr_istri.tujuan,asesmen_keperawatan_gsr_istri.ttljamkala,asesmen_keperawatan_gsr_istri.ttlmenitkala,asesmen_keperawatan_gsr_istri.ttldarahan,asesmen_keperawatan_gsr_istri.nip"+
                                
                        "dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join asesmen_keperawatan_gsr_istri on reg_periksa.no_rawat=asesmen_keperawatan_gsr_istri.no_rawat "+
                        "inner join petugas on penilaian_awal_keperawatan_ranap.nip=petugas.nip "+
                        "inner join dokter on asesmen_keperawatan_gsr_istri.kd_dokter=dokter.kd_dokter where "+
                        "asesmen_keperawatan_gsr_istri.tanggal between ? and ? order by asesmen_keperawatan_gsr_istri.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AsesmenAwalKeperawatanGSRIstri dialog = new AsesmenAwalKeperawatanGSRIstri(new javax.swing.JFrame(), true);
        ...
        try{	
            if(TCari.getText().trim().equals("")){	
                ps=koneksi.prepareStatement(	
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+	
                        "inner join asesmen_keperawatan_gsr_istri on reg_periksa.no_rawat=asesmen_keperawatan_gsr_istri.no_rawat "+	
                        "inner join petugas on asesmen_keperawatan_gsr_istri.nip=petugas.nip "+
                        "inner join dokter on asesmen_keperawatan_gsr_istri.kd_dokter=dokter.kd_dokter where "+
                        "asesmen_keperawatan_gsr_istri.tanggal between ? and ? "+
                        (TCari.getText().trim().equals("")?"":"and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or asesmen_keperawatan_gsr_istri.nip like ? or "+
                        "petugas.nama like ? or asesmen_keperawatan_gsr_istri.kd_dokter like ? or dokter.nm_dokter like ?)")+
                        " order by asesmen_keperawatan_gsr_istri.tanggal");        
//                        "asesmen_keperawatan_gsr_istri.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+	
//                        "asesmen_keperawatan_gsr_istri.kd_dokter like ? or dokter.nm_dokter like ?) order by asesmen_keperawatan_gsr_istri.tanggal");	
            }else{	
                ps=koneksi.prepareStatement(	
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,"+	
                       	"asesmen_keperawatan_gsr_istri.tanggal,asesmen_keperawatan_gsr_istri.kd_dokter,asesmen_keperawatan_gsr_istri.keluhan_utama,asesmen_keperawatan_gsr_istri.jenis_persalinan,asesmen_keperawatan_gsr_istri.indikasi_sc,asesmen_keperawatan_gsr_istri.anak,asesmen_keperawatan_gsr_istri.jenis_kelamin,asesmen_keperawatan_gsr_istri.bb,asesmen_keperawatan_gsr_istri.pb,asesmen_keperawatan_gsr_istri.ketuban_pecah,"+	
...
//                    ps.setString(7,"%"+TCari.getText()+"%");
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from asesmen_keperawatan_gsr_istri where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("asesmen_keperawatan_gsr_istri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,"+
