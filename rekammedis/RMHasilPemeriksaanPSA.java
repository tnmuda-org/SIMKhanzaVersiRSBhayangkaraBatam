 ...
 * @author perpustakaan
 */
public final class RMHasilPemeriksaanPSA extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilPemeriksaanPSA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","Kode Dokter","Nama Dokter","Tanggal","Regio","Diagnose",
            "BSA","JSA","Benda Asing","OSA","PSA","RSA","PUS","Granuloma","Kista","Kesimpulan"
        }){
        ...
        Regio.setDocument(new batasInput((int)50).getKata(Regio));
...
//        Plasenta.setDocument(new batasInput((int)50).getKata(Plasenta));
    ...
    private void initComponents() {
        ...
        Bsa = new widget.ComboBox();
        jLabel42 = new widget.Label();
        Jsa = new widget.ComboBox();
        jLabel43 = new widget.Label();
        BendaAsing = new widget.ComboBox();
        jLabel44 = new widget.Label();
        Osa = new widget.ComboBox();
        jLabel45 = new widget.Label();
        Psa = new widget.ComboBox();
        jLabel46 = new widget.Label();
        Rsa = new widget.ComboBox();
        jLabel47 = new widget.Label();
        Pus = new widget.ComboBox();
        jLabel48 = new widget.Label();
        Granuloma = new widget.ComboBox();
        jLabel49 = new widget.Label();
        Kista = new widget.ComboBox();
        ...
        MnPenilaianMedis.setText("Formulir Perawatan Saluran Akar");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan PSA ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-10-2023 13:35:35" }));
        ...
        jLabel41.setText("Bentuk Saluran Akar :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 160, 150, 23);

        Bsa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sempit", "Normal", "Besar" }));
        Bsa.setName("Bsa"); // NOI18N
        Bsa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BsaActionPerformed(evt);
            }
        });
        Bsa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BsaKeyPressed(evt);
            }
        });
        FormInput.add(Bsa);
        Bsa.setBounds(160, 160, 150, 23);

        jLabel42.setText("Jumlah Saluran Akar :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 190, 150, 23);

        Jsa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Satu", "Dua", "Tiga", "Empat", ">4" }));
        Jsa.setName("Jsa"); // NOI18N
        Jsa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JsaActionPerformed(evt);
            }
        });
        Jsa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                JsaKeyPressed(evt);
            }
        });
        FormInput.add(Jsa);
        Jsa.setBounds(160, 190, 150, 23);

        jLabel43.setText("Benda Asing :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 220, 150, 23);
        ...
        BendaAsing.setBounds(160, 220, 150, 23);

        jLabel44.setText("Obstruksi Saluran Akar :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 250, 150, 23);

        Osa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        ...
        Osa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                OsaKeyPressed(evt);
            }
        });
        FormInput.add(Osa);
        Osa.setBounds(160, 250, 150, 23);

        jLabel45.setText("Perforasi Saluran Akar :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 280, 150, 23);

        Psa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        ...
        FormInput.add(Psa);
        Psa.setBounds(160, 280, 150, 23);

        jLabel46.setText("Readsorpsi Saluran Akar :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(350, 160, 150, 23);

        Rsa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        Rsa.setName("Rsa"); // NOI18N
        Rsa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RsaActionPerformed(evt);
            }
        });
        Rsa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RsaKeyPressed(evt);
            }
        });
        FormInput.add(Rsa);
        Rsa.setBounds(510, 160, 150, 23);

        jLabel47.setText("PUS :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(350, 190, 150, 23);

        Pus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        ...
        Pus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PusKeyPressed(evt);
            }
        });
        FormInput.add(Pus);
        Pus.setBounds(510, 190, 150, 23);

        jLabel48.setText("Granuloma :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(350, 220, 150, 23);

        Granuloma.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        Granuloma.setName("Granuloma"); // NOI18N
        Granuloma.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GranulomaActionPerformed(evt);
            }
        });
        Granuloma.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GranulomaKeyPressed(evt);
            }
        });
        FormInput.add(Granuloma);
        Granuloma.setBounds(510, 220, 150, 23);

        jLabel49.setText("Kista :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(350, 250, 150, 23);

        Kista.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak Ada" }));
        Kista.setName("Kista"); // NOI18N
        Kista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KistaActionPerformed(evt);
            }
        });
        Kista.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KistaKeyPressed(evt);
            }
        });
        FormInput.add(Kista);
        Kista.setBounds(510, 250, 150, 23);

        jLabel33.setText("Diagnose :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 130, 150, 23);
        ...
        Diagnosis.setBounds(160, 130, 550, 23);

        jLabel34.setText("Regio :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 100, 150, 23);
        ...
        FormInput.add(Regio);
        Regio.setBounds(160, 100, 550, 23);

        jLabel50.setText("Kesimpulan :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(0, 310, 150, 23);
        ...
        scrollPane17.setBounds(160, 310, 540, 63);

        scrollInput.setViewportView(FormInput);

        internalFrame2.add(scrollInput, java.awt.BorderLayout.CENTER);

        TabRawat.addTab("Input Hasil Pemeriksaan PSA", internalFrame2);
        ...
        TabRawat.addTab("Data Hasil Pemeriksaan PSA", internalFrame3);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Regio.getText().trim().equals("")){
            Valid.textKosong(Regio,"Regio");
        }else if(Diagnosis.getText().trim().equals("")){
            Valid.textKosong(Diagnosis,"Diagnosis");
        }else{
            if(Sequel.menyimpantf("hasil_pemeriksaan_psa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
                    TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                    Regio.getText(),Diagnosis.getText(),Bsa.getSelectedItem().toString(),Jsa.getSelectedItem().toString(),
                    BendaAsing.getSelectedItem().toString(),Osa.getSelectedItem().toString(),Psa.getSelectedItem().toString(),
                    Rsa.getSelectedItem().toString(),Pus.getSelectedItem().toString(),Granuloma.getSelectedItem().toString(),Kista.getSelectedItem().toString(),Kesimpulan.getText()
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanPSA.jasper","report","::[ Formulir Hasil Perawatan Saluran Akar ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_psa.tanggal,"+
                ...
                "inner join dokter on hasil_pemeriksaan_psa.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_psa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void BsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BsaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BsaKeyPressed
    ...
    private void JsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JsaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_JsaKeyPressed
    ...
    private void OsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_OsaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_OsaKeyPressed
    ...
    private void RsaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RsaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RsaKeyPressed
    ...
    private void PusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PusKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PusKeyPressed

    private void GranulomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GranulomaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_GranulomaActionPerformed

    private void GranulomaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GranulomaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_GranulomaKeyPressed

    private void KistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KistaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KistaActionPerformed

    private void KistaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KistaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KistaKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanPSA dialog = new RMHasilPemeriksaanPSA(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox Granuloma;
    private widget.ComboBox Jsa;
    private widget.TextBox KdDokter;
    private widget.TextArea Kesimpulan;
    private widget.ComboBox Kista;
    private widget.Label LCount;
    private widget.editorpane LoadHTML;
    private widget.editorpane LoadHTML2;
    private javax.swing.JMenuItem MnPenilaianMedis;
    private widget.TextBox NmDokter;
    private widget.ComboBox Osa;
    private widget.PanelBiasa PanelAccor;
    private widget.ComboBox Psa;
    private widget.ComboBox Pus;
    private widget.TextBox Regio;
    private widget.ComboBox Rsa;
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_psa.tanggal,"+
                        ...
                        "hasil_pemeriksaan_psa.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join hasil_pemeriksaan_psa on reg_periksa.no_rawat=hasil_pemeriksaan_psa.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_psa.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_psa.tanggal between ? and ? order by hasil_pemeriksaan_psa.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_psa.tanggal,"+
                       "hasil_pemeriksaan_psa.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_psa.regio,hasil_pemeriksaan_psa.diagnosis,"+
                        ...
                        "inner join hasil_pemeriksaan_psa on reg_periksa.no_rawat=hasil_pemeriksaan_psa.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_psa.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_psa.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "hasil_pemeriksaan_psa.kd_dokter like ? or dokter.nm_dokter like ?) order by hasil_pemeriksaan_psa.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("regio"),rs.getString("diagnosis"),rs.getString("bsa"),rs.getString("jsa"),rs.getString("benda_asing"),rs.getString("osa"),
                        rs.getString("psa"),rs.getString("rsa"),rs.getString("pus"),rs.getString("granuloma"),rs.getString("kista"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Regio.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Bsa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            Jsa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            BendaAsing.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            Osa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            Psa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            Rsa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Pus.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Granuloma.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            Kista.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from hasil_pemeriksaan_psa where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_psa","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,regio=?,diagnosis=?,bsa=?,jsa=?,benda_asing=?,"+
                "osa=?,psa=?,rsa=?,pus=?,granuloma=?,kista=?,kesimpulan=?",16,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                Regio.getText(),Diagnosis.getText(),Bsa.getSelectedItem().toString(),Jsa.getSelectedItem().toString(),
                BendaAsing.getSelectedItem().toString(),Osa.getSelectedItem().toString(),Psa.getSelectedItem().toString(),
                Rsa.getSelectedItem().toString(),Pus.getSelectedItem().toString(),Granuloma.getSelectedItem().toString(),Kista.getSelectedItem().toString(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
               tampil();
               emptTeks();
               TabRawat.setSelectedIndex(1);
