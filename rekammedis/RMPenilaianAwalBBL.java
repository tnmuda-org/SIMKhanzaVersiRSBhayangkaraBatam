 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalBBL extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalBBL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Bayi Baru Lahir ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-12-2023 09:30:53" }));
        ...
        SkalaSydney7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bermacam-macam Obat Yang Digunakan : Obat Sedative (Kecuali Pasien ICU Yang Menggunakan sedasi dan paralisis), Hipnotik, Barbiturat, Fenoti-Azin, Antidepresan, Laksans/Diuretika,Narkotik", "Salah Satu Dari Pengobatan Di Atas", "Penggunaan Medikasi Lainnya / Tidak Ada Medikasi" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_bbl","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",200,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                ps=koneksi.prepareStatement(
                    "select penilaian_awal_bbl.no_rawat,penilaian_awal_bbl.tanggal,penilaian_awal_bbl.informasi,penilaian_awal_bbl.ket_informasi,penilaian_awal_bbl.tiba_diruang_rawat,"+
                    "penilaian_awal_bbl.kasus_trauma,penilaian_awal_bbl.cara_masuk,penilaian_awal_bbl.rps,penilaian_awal_bbl.rpd,penilaian_awal_bbl.rpk,penilaian_awal_bbl.rpo,"+
                    "penilaian_awal_bbl.riwayat_pembedahan,penilaian_awal_bbl.riwayat_dirawat_dirs,penilaian_awal_bbl.alat_bantu_dipakai,penilaian_awal_bbl.riwayat_kehamilan,"+
                    "penilaian_awal_bbl.riwayat_kehamilan_perkiraan,penilaian_awal_bbl.riwayat_tranfusi,penilaian_awal_bbl.riwayat_alergi,penilaian_awal_bbl.riwayat_merokok,"+
                    "penilaian_awal_bbl.riwayat_merokok_jumlah,penilaian_awal_bbl.riwayat_alkohol,penilaian_awal_bbl.riwayat_alkohol_jumlah,penilaian_awal_bbl.riwayat_narkoba,"+
                    "penilaian_awal_bbl.riwayat_olahraga,penilaian_awal_bbl.pemeriksaan_mental,penilaian_awal_bbl.pemeriksaan_keadaan_umum,penilaian_awal_bbl.pemeriksaan_gcs,"+
                    "penilaian_awal_bbl.pemeriksaan_td,penilaian_awal_bbl.pemeriksaan_nadi,penilaian_awal_bbl.pemeriksaan_rr,penilaian_awal_bbl.pemeriksaan_suhu,"+
                    "penilaian_awal_bbl.pemeriksaan_spo2,penilaian_awal_bbl.pemeriksaan_bb,penilaian_awal_bbl.pemeriksaan_tb,penilaian_awal_bbl.pemeriksaan_susunan_kepala,"+
                    "penilaian_awal_bbl.pemeriksaan_susunan_kepala_keterangan,penilaian_awal_bbl.pemeriksaan_susunan_wajah,penilaian_awal_bbl.pemeriksaan_susunan_wajah_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_susunan_leher,penilaian_awal_bbl.pemeriksaan_susunan_kejang,penilaian_awal_bbl.pemeriksaan_susunan_kejang_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_susunan_sensorik,penilaian_awal_bbl.pemeriksaan_kardiovaskuler_denyut_nadi,penilaian_awal_bbl.pemeriksaan_kardiovaskuler_sirkulasi,"+
                    "penilaian_awal_bbl.pemeriksaan_kardiovaskuler_sirkulasi_keterangan,penilaian_awal_bbl.pemeriksaan_kardiovaskuler_pulsasi,penilaian_awal_bbl.pemeriksaan_respirasi_pola_nafas,"+
                    "penilaian_awal_bbl.pemeriksaan_respirasi_retraksi,penilaian_awal_bbl.pemeriksaan_respirasi_suara_nafas,penilaian_awal_bbl.pemeriksaan_respirasi_volume_pernafasan,"+
                    "penilaian_awal_bbl.pemeriksaan_respirasi_jenis_pernafasan,penilaian_awal_bbl.pemeriksaan_respirasi_jenis_pernafasan_keterangan,penilaian_awal_bbl.pemeriksaan_respirasi_irama_nafas,"+
                    "penilaian_awal_bbl.pemeriksaan_respirasi_batuk,penilaian_awal_bbl.pemeriksaan_gastrointestinal_mulut,penilaian_awal_bbl.pemeriksaan_gastrointestinal_mulut_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_gastrointestinal_gigi,penilaian_awal_bbl.pemeriksaan_gastrointestinal_gigi_keterangan,penilaian_awal_bbl.pemeriksaan_gastrointestinal_lidah,"+
                    "penilaian_awal_bbl.pemeriksaan_gastrointestinal_lidah_keterangan,penilaian_awal_bbl.pemeriksaan_gastrointestinal_tenggorokan,penilaian_awal_bbl.pemeriksaan_gastrointestinal_tenggorokan_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_gastrointestinal_abdomen,penilaian_awal_bbl.pemeriksaan_gastrointestinal_abdomen_keterangan,penilaian_awal_bbl.pemeriksaan_gastrointestinal_peistatik_usus,"+
                    "penilaian_awal_bbl.pemeriksaan_gastrointestinal_anus,penilaian_awal_bbl.pemeriksaan_neurologi_pengelihatan,penilaian_awal_bbl.pemeriksaan_neurologi_pengelihatan_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_neurologi_alat_bantu_penglihatan,penilaian_awal_bbl.pemeriksaan_neurologi_pendengaran,penilaian_awal_bbl.pemeriksaan_neurologi_bicara,"+
                    "penilaian_awal_bbl.pemeriksaan_neurologi_bicara_keterangan,penilaian_awal_bbl.pemeriksaan_neurologi_sensorik,penilaian_awal_bbl.pemeriksaan_neurologi_motorik,"+
                    "penilaian_awal_bbl.pemeriksaan_neurologi_kekuatan_otot,penilaian_awal_bbl.pemeriksaan_integument_warnakulit,penilaian_awal_bbl.pemeriksaan_integument_turgor,"+
                    "penilaian_awal_bbl.pemeriksaan_integument_kulit,penilaian_awal_bbl.pemeriksaan_integument_dekubitas,penilaian_awal_bbl.pemeriksaan_muskuloskletal_pergerakan_sendi,"+
                    "penilaian_awal_bbl.pemeriksaan_muskuloskletal_kekauatan_otot,penilaian_awal_bbl.pemeriksaan_muskuloskletal_nyeri_sendi,penilaian_awal_bbl.pemeriksaan_muskuloskletal_nyeri_sendi_keterangan,"+
                    "penilaian_awal_bbl.pemeriksaan_muskuloskletal_oedema,penilaian_awal_bbl.pemeriksaan_muskuloskletal_oedema_keterangan,penilaian_awal_bbl.pemeriksaan_muskuloskletal_fraktur,"+
                    "penilaian_awal_bbl.pemeriksaan_muskuloskletal_fraktur_keterangan,penilaian_awal_bbl.pemeriksaan_eliminasi_bab_frekuensi_jumlah,penilaian_awal_bbl.pemeriksaan_eliminasi_bab_frekuensi_durasi,"+
                    "penilaian_awal_bbl.pemeriksaan_eliminasi_bab_konsistensi,penilaian_awal_bbl.pemeriksaan_eliminasi_bab_warna,penilaian_awal_bbl.pemeriksaan_eliminasi_bak_frekuensi_jumlah,"+
                    "penilaian_awal_bbl.pemeriksaan_eliminasi_bak_frekuensi_durasi,penilaian_awal_bbl.pemeriksaan_eliminasi_bak_warna,penilaian_awal_bbl.pemeriksaan_eliminasi_bak_lainlain,"+
                    "penilaian_awal_bbl.pola_aktifitas_makanminum,penilaian_awal_bbl.pola_aktifitas_mandi,penilaian_awal_bbl.pola_aktifitas_eliminasi,penilaian_awal_bbl.pola_aktifitas_berpakaian,"+
                    "penilaian_awal_bbl.pola_aktifitas_berpindah,penilaian_awal_bbl.pola_nutrisi_frekuesi_makan,penilaian_awal_bbl.pola_nutrisi_jenis_makanan,penilaian_awal_bbl.pola_nutrisi_porsi_makan,"+
                    "penilaian_awal_bbl.pola_tidur_lama_tidur,penilaian_awal_bbl.pola_tidur_gangguan,penilaian_awal_bbl.pengkajian_fungsi_kemampuan_sehari,penilaian_awal_bbl.pengkajian_fungsi_aktifitas,"+
                    "penilaian_awal_bbl.pengkajian_fungsi_berjalan,penilaian_awal_bbl.pengkajian_fungsi_berjalan_keterangan,penilaian_awal_bbl.pengkajian_fungsi_ambulasi,"+
                    "penilaian_awal_bbl.pengkajian_fungsi_ekstrimitas_atas,penilaian_awal_bbl.pengkajian_fungsi_ekstrimitas_atas_keterangan,penilaian_awal_bbl.pengkajian_fungsi_ekstrimitas_bawah,"+
                    "penilaian_awal_bbl.pengkajian_fungsi_ekstrimitas_bawah_keterangan,penilaian_awal_bbl.pengkajian_fungsi_menggenggam,penilaian_awal_bbl.pengkajian_fungsi_menggenggam_keterangan,"+
                    "penilaian_awal_bbl.pengkajian_fungsi_koordinasi,penilaian_awal_bbl.pengkajian_fungsi_koordinasi_keterangan,penilaian_awal_bbl.pengkajian_fungsi_kesimpulan,"+
                    "penilaian_awal_bbl.riwayat_psiko_kondisi_psiko,penilaian_awal_bbl.riwayat_psiko_gangguan_jiwa,penilaian_awal_bbl.riwayat_psiko_perilaku,"+
                    "penilaian_awal_bbl.riwayat_psiko_perilaku_keterangan,penilaian_awal_bbl.riwayat_psiko_hubungan_keluarga,penilaian_awal_bbl.riwayat_psiko_tinggal,"+
                    "penilaian_awal_bbl.riwayat_psiko_tinggal_keterangan,penilaian_awal_bbl.riwayat_psiko_nilai_kepercayaan,penilaian_awal_bbl.riwayat_psiko_nilai_kepercayaan_keterangan,"+
                    "penilaian_awal_bbl.riwayat_psiko_pendidikan_pj,penilaian_awal_bbl.riwayat_psiko_edukasi_diberikan,penilaian_awal_bbl.riwayat_psiko_edukasi_diberikan_keterangan,"+
                    "penilaian_awal_bbl.penilaian_nyeri,penilaian_awal_bbl.penilaian_nyeri_penyebab,penilaian_awal_bbl.penilaian_nyeri_ket_penyebab,penilaian_awal_bbl.penilaian_nyeri_kualitas,"+
                    "penilaian_awal_bbl.penilaian_nyeri_ket_kualitas,penilaian_awal_bbl.penilaian_nyeri_lokasi,penilaian_awal_bbl.penilaian_nyeri_menyebar,penilaian_awal_bbl.penilaian_nyeri_skala,"+
                    "penilaian_awal_bbl.penilaian_nyeri_waktu,penilaian_awal_bbl.penilaian_nyeri_hilang,penilaian_awal_bbl.penilaian_nyeri_ket_hilang,penilaian_awal_bbl.penilaian_nyeri_diberitahukan_dokter,"+
                    "penilaian_awal_bbl.penilaian_nyeri_jam_diberitahukan_dokter,penilaian_awal_bbl.penilaian_jatuhmorse_skala1,penilaian_awal_bbl.penilaian_jatuhmorse_nilai1,"+
                    "penilaian_awal_bbl.penilaian_jatuhmorse_skala2,penilaian_awal_bbl.penilaian_jatuhmorse_nilai2,penilaian_awal_bbl.penilaian_jatuhmorse_skala3,"+
                    "penilaian_awal_bbl.penilaian_jatuhmorse_nilai3,penilaian_awal_bbl.penilaian_jatuhmorse_skala4,penilaian_awal_bbl.penilaian_jatuhmorse_nilai4,"+
                    "penilaian_awal_bbl.penilaian_jatuhmorse_skala5,penilaian_awal_bbl.penilaian_jatuhmorse_nilai5,"+
                    "penilaian_awal_bbl.penilaian_jatuhmorse_totalnilai,penilaian_awal_bbl.penilaian_jatuhsydney_skala1,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_nilai1,penilaian_awal_bbl.penilaian_jatuhsydney_skala2,penilaian_awal_bbl.penilaian_jatuhsydney_nilai2,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_skala3,penilaian_awal_bbl.penilaian_jatuhsydney_nilai3,penilaian_awal_bbl.penilaian_jatuhsydney_skala4,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_nilai4,penilaian_awal_bbl.penilaian_jatuhsydney_skala5,penilaian_awal_bbl.penilaian_jatuhsydney_nilai5,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_skala6,penilaian_awal_bbl.penilaian_jatuhsydney_nilai6,penilaian_awal_bbl.penilaian_jatuhsydney_skala7,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_nilai7,"+
                    "penilaian_awal_bbl.penilaian_jatuhsydney_totalnilai,penilaian_awal_bbl.skrining_gizi1,penilaian_awal_bbl.nilai_gizi1,penilaian_awal_bbl.skrining_gizi2,"+
                    "penilaian_awal_bbl.nilai_gizi2,penilaian_awal_bbl.nilai_total_gizi,penilaian_awal_bbl.skrining_gizi_diagnosa_khusus,penilaian_awal_bbl.skrining_gizi_ket_diagnosa_khusus,"+
                    "penilaian_awal_bbl.skrining_gizi_diketahui_dietisen,penilaian_awal_bbl.skrining_gizi_jam_diketahui_dietisen,penilaian_awal_bbl.rencana,penilaian_awal_bbl.nip1,"+
                    "penilaian_awal_bbl.nip2,penilaian_awal_bbl.kd_dokter,pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,"+
                    ...
                    "inner join penilaian_awal_bbl on reg_periksa.no_rawat=penilaian_awal_bbl.no_rawat "+
                    "inner join petugas as pengkaji1 on penilaian_awal_bbl.nip1=pengkaji1.nip "+
                    "inner join petugas as pengkaji2 on penilaian_awal_bbl.nip2=pengkaji2.nip "+
                    "inner join dokter on penilaian_awal_bbl.kd_dokter=dokter.kd_dokter "+
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalBbl.jasper","report","::[ Laporan Penilaian Awal Bayi Baru Lahir ]::",
                "select penilaian_awal_bbl.no_rawat,penilaian_awal_bbl.tanggal,penilaian_awal_bbl.informasi,penilaian_awal_bbl.ket_informasi,penilaian_awal_bbl.tiba_diruang_rawat,"+
                "penilaian_awal_bbl.kasus_trauma,penilaian_awal_bbl.cara_masuk,penilaian_awal_bbl.rps,penilaian_awal_bbl.rpd,penilaian_awal_bbl.rpk,penilaian_awal_bbl.rpo,"+
                "penilaian_awal_bbl.riwayat_pembedahan,penilaian_awal_bbl.riwayat_dirawat_dirs,penilaian_awal_bbl.alat_bantu_dipakai,penilaian_awal_bbl.riwayat_kehamilan,"+
                "penilaian_awal_bbl.riwayat_kehamilan_perkiraan,penilaian_awal_bbl.riwayat_tranfusi,penilaian_awal_bbl.riwayat_alergi,penilaian_awal_bbl.riwayat_merokok,"+
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalBbl2.jasper","report","::[ Laporan Penilaian Awal Bayi Baru Lahir ]::",
                "select penilaian_awal_bbl.no_rawat,penilaian_awal_bbl.tanggal,penilaian_awal_bbl.informasi,penilaian_awal_bbl.ket_informasi,penilaian_awal_bbl.tiba_diruang_rawat,"+
                "penilaian_awal_bbl.kasus_trauma,penilaian_awal_bbl.cara_masuk,penilaian_awal_bbl.rps,penilaian_awal_bbl.rpd,penilaian_awal_bbl.rpk,penilaian_awal_bbl.rpo,"+
                "penilaian_awal_bbl.riwayat_pembedahan,penilaian_awal_bbl.riwayat_dirawat_dirs,penilaian_awal_bbl.alat_bantu_dipakai,penilaian_awal_bbl.riwayat_kehamilan,"+
                "penilaian_awal_bbl.riwayat_kehamilan_perkiraan,penilaian_awal_bbl.riwayat_tranfusi,penilaian_awal_bbl.riwayat_alergi,penilaian_awal_bbl.riwayat_merokok,"+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalBBL dialog = new RMPenilaianAwalBBL(new javax.swing.JFrame(), true);
        ...
        try{
            ps=koneksi.prepareStatement(
              "select penilaian_awal_bbl.no_rawat,penilaian_awal_bbl.tanggal,penilaian_awal_bbl.informasi,penilaian_awal_bbl.ket_informasi,penilaian_awal_bbl.tiba_diruang_rawat,"+
                ...
                "penilaian_awal_bbl.penilaian_jatuhsydney_totalnilai,penilaian_awal_bbl.skrining_gizi1,penilaian_awal_bbl.nilai_gizi1,penilaian_awal_bbl.skrining_gizi2,"+
                "penilaian_awal_bbl.nilai_gizi2,penilaian_awal_bbl.nilai_total_gizi,penilaian_awal_bbl.skrining_gizi_diagnosa_khusus,penilaian_awal_bbl.skrining_gizi_ket_diagnosa_khusus,"+
                "penilaian_awal_bbl.skrining_gizi_diketahui_dietisen,penilaian_awal_bbl.skrining_gizi_jam_diketahui_dietisen,penilaian_awal_bbl.rencana,penilaian_awal_bbl.nip1,penilaian_awal_bbl.apgar_score,lingkar_kepala,lingkar_dada,lingkar_perut,lingkar_lengan,tangis,gerakan,refleks_moro,refleks_genggam,refleks_rooting,refleks_hisap,labio,cara_minum,suhu_tubuh,kepala,mata_secret,tali_pusat,"+
                "penilaian_awal_bbl.nip2,penilaian_awal_bbl.kd_dokter,pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,"+
                "reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.agama,pasien.pekerjaan,pasien.pnd,penjab.png_jawab,bahasa_pasien.nama_bahasa "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_awal_bbl on reg_periksa.no_rawat=penilaian_awal_bbl.no_rawat "+
                ...
                "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                "inner join penjab on penjab.kd_pj=reg_periksa.kd_pj where "+
                "penilaian_awal_bbl.tanggal between ? and ? "+
                (TCari.getText().trim().equals("")?"":"and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_bbl.nip1 like ? or "+
                "pengkaji1.nama like ? or penilaian_awal_bbl.kd_dokter like ? or dokter.nm_dokter like ?)")+
                " order by penilaian_awal_bbl.tanggal");
...
//            NilaiSydney11.setText(tbObat.getValueAt(tbObat.getSelectedRow(),161).toString());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_bbl where no_rawat=?",1,new String[]{
