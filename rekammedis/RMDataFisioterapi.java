 ...
 * @author perpustakaan
 */
public final class RMDataFisioterapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataFisioterapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tgl.Rawat","No.Rawat","No.RM","Nama Pasien","Kode Dokter","Dokter Penanggung Jawab","Pulang","Subjective",
            "Objective","Assesment","Prosedure","Diagnosa Fungsional","Kode ICD10","Diagnosa Medis",
            "Kode ICD10","Goal Of Treatment","ICD10 Sek 2","Program Rehab Medik","ICD10 Sek 3","Edukasi","ICD10 Sek 4","Frekuensi Kunjungan","ICD9 Utama",
            "Instrumen Uji Fungsi","ICD9 Sek1","Hasil Pemeriksaan","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Obat-obatan waktu pulang/nasihat"
        }){
        ...
        for (i = 0; i < 30; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(250); //subjective
            }else if(i==8){
                column.setPreferredWidth(250);//Objective
            }else if(i==9){
                column.setPreferredWidth(250);//assesment
            }else if(i==10){
                column.setPreferredWidth(250);//prosedure
            }else if(i==11){
                column.setPreferredWidth(170);//Diagnosa Fungsional
            }else if(i==12){
                column.setPreferredWidth(75);//Diagnosa Medis
            }else if(i==13){
                column.setPreferredWidth(170);//GOT
            }else if(i==14){
                ...
                column.setPreferredWidth(250); //instrumen
            }else if(i==22){
                column.setPreferredWidth(75);
            }else if(i==23){
                column.setPreferredWidth(170);
        ...
        DiagnosaSekunder2.setDocument(new batasInput((int)2000).getKata(DiagnosaSekunder2));
        DiagnosaSekunder3.setDocument(new batasInput((int)2000).getKata(DiagnosaSekunder3));
        DiagnosaSekunder4.setDocument(new batasInput((int)2000).getKata(DiagnosaSekunder4));
        ProsedurUtama.setDocument(new batasInput((int)2000).getKata(ProsedurUtama));
        ProsedurSekunder1.setDocument(new batasInput((int)2000).getKata(ProsedurSekunder1));
        ProsedurSekunder2.setDocument(new batasInput((int)2000).getKata(ProsedurSekunder2));
        ProsedurSekunder3.setDocument(new batasInput((int)2000).getKata(ProsedurSekunder3));
    ...
    private void initComponents() {
        ...
        MnLaporanResume.setText("Print Lembar Rajal");
        ...
        MnSPBK.setText("Print Hasil Uji Fungsi");
        ...
        MnSPBK2.setText("Print Program Pasien Fisioterapi");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pasien Fisioterapi / Rehabilitasi Medik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Subjective  : ");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(-80, 70, 240, 23);
        ...
        jLabel25.setText("Goal of Treatment  : ");
        jLabel25.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(10, 350, 200, 23);
        ...
        DiagnosaSekunder2.setBounds(220, 350, 520, 23);

        jLabel26.setText("Tindakan / Program Rehabilitasi Medik  : ");
        jLabel26.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(10, 380, 200, 23);
        ...
        DiagnosaUtama.setBounds(940, 70, 350, 23);

        jLabel27.setText("Diagnosa Fungsional  : ");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(790, 70, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(220, 380, 520, 23);

        jLabel28.setText("Edukasi  : ");
        jLabel28.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(10, 410, 200, 23);
        ...
        DiagnosaSekunder4.setBounds(220, 410, 520, 23);
        ...
        scrollPane2.setBounds(160, 70, 620, 50);
        ...
        jLabel8.setBounds(-80, 130, 240, 23);
        ...
        scrollPane3.setBounds(160, 130, 620, 50);

        jLabel9.setText("Assesment  : ");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(-80, 190, 240, 23);
        ...
        scrollPane4.setBounds(160, 190, 620, 50);

        jLabel10.setText("Prosedure  : ");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(-80, 250, 240, 23);
        ...
        scrollPane5.setBounds(160, 250, 620, 50);

        jLabel11.setText("Kesimpulan  : ");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(710, 210, 220, 23);
        ...
        scrollPane6.setBounds(940, 210, 520, 70);

        jLabel30.setText("Diagnosa Medis  : ");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(790, 100, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(940, 100, 350, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(1150, 40, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(1300, 70, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(1300, 100, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(2670, 410, 50, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(2670, 440, 50, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(2670, 470, 50, 23);

        jLabel32.setText("Program Rehabilitasi :");
        jLabel32.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(60, 440, 145, 23);
        ...
        ProsedurUtama.setBounds(220, 440, 520, 23);
        ...
        KodeProsedurUtama.setBounds(2670, 500, 50, 23);
        ...
        ProsedurSekunder1.setBounds(940, 130, 520, 23);

        jLabel33.setText("Instrumen uji fungsi KFR : ");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(790, 130, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(2670, 530, 60, 23);
        ...
        ProsedurSekunder2.setBounds(2720, 380, 40, 23);
        ...
        KodeProsedurSekunder2.setBounds(2670, 560, 60, 23);
        ...
        KodeProsedurSekunder3.setBounds(2670, 590, 60, 23);
        ...
        ProsedurSekunder3.setBounds(940, 170, 520, 23);

        jLabel35.setText("Rekomendasi  :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(790, 170, 145, 23);
        ...
        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Evaluasi", "Rujuk", "Selesai" }));
        ...
        jLabel12.setText("Rencana Tindak Lanjut : ");
        ...
        BtnDokter1.setBounds(100, 100, 28, 23);
        ...
        BtnDokter4.setBounds(2700, 620, 28, 23);
        ...
        BtnDokter5.setBounds(130, 100, 28, 23);

        jLabel36.setText("Instrumen Uji Fungsi / Prosedur KFR : ");
        jLabel36.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(800, 40, 270, 23);
        ...
        jLabel37.setBounds(10, 480, 790, 23);

        jLabel38.setText("Planning / Tindak Lanjut  : ");
        jLabel38.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(0, 320, 200, 23);
        ...
        jLabel39.setBounds(10, 300, 790, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("fisioterapi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",26,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataFisioterapi.jasper","report","::[ Data Resume Pasien ]::",
                        "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                        "fisioterapi.kd_dokter,dokter.nm_dokter,fisioterapi.kondisi_pulang,fisioterapi.keluhan_utama,fisioterapi.jalannya_penyakit, "+
                        "fisioterapi.pemeriksaan_penunjang,fisioterapi.hasil_laborat,fisioterapi.diagnosa_utama,fisioterapi.kd_diagnosa_utama, "+
                        "fisioterapi.diagnosa_sekunder,fisioterapi.kd_diagnosa_sekunder,fisioterapi.diagnosa_sekunder2,fisioterapi.kd_diagnosa_sekunder2, "+
                        "fisioterapi.diagnosa_sekunder3,fisioterapi.kd_diagnosa_sekunder3,fisioterapi.diagnosa_sekunder4,fisioterapi.kd_diagnosa_sekunder4, "+
                        "fisioterapi.prosedur_utama,fisioterapi.kd_prosedur_utama,fisioterapi.prosedur_sekunder,fisioterapi.kd_prosedur_sekunder, "+
                        "fisioterapi.prosedur_sekunder2,fisioterapi.kd_prosedur_sekunder2,fisioterapi.prosedur_sekunder3,fisioterapi.kd_prosedur_sekunder3, "+
                        "fisioterapi.obat_pulang from fisioterapi inner join reg_periksa on fisioterapi.no_rawat=reg_periksa.no_rawat  "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on fisioterapi.kd_dokter=dokter.kd_dokter "+
                    ...
                    Valid.MyReportqry("rptDataFisioterapi.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "fisioterapi.kd_dokter like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%' or "+
                        "fisioterapi.kondisi_pulang like '%"+TCari.getText().trim()+"%' or fisioterapi.kd_diagnosa_utama like '%"+TCari.getText().trim()+"%' or "+
                        "fisioterapi.diagnosa_utama like '%"+TCari.getText().trim()+"%' or fisioterapi.prosedur_utama like '%"+TCari.getText().trim()+"%' or "+
                        "reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or fisioterapi.kd_prosedur_utama like '%"+TCari.getText().trim()+"%') "+
                        "order by reg_periksa.tgl_registrasi",param);
                }
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptLaporanFisioterapi.jasper","report","::[ Print Formulir Rajal ]::",param);
        }
...
//        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnSPBKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSPBKActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptHasilFisioterapi.jasper","report","::[ Print Hasil Uji Fungsi ]::",param);
        }
...
if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptProgramFisioterapi.jasper","report","::[ Print Program Pasien Fisioterapi]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataFisioterapi dialog = new RMDataFisioterapi(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "(reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or fisioterapi.kd_dokter like ? or "+
                    "dokter.nm_dokter like ? or fisioterapi.kondisi_pulang like ? or fisioterapi.kd_diagnosa_utama like ? or "+
                    "fisioterapi.diagnosa_utama like ? or fisioterapi.prosedur_utama like ? or reg_periksa.no_rawat like ? or "+
                    "fisioterapi.kd_prosedur_utama like ?) order by reg_periksa.tgl_registrasi");
            }
            try {
                if(TCari.getText().equals("")){
    ...
    private void isRawat() {
         ...
         if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_igd where no_rawat='"+TNoRw.getText()+"' ")>0){
            ...
            Keluhan.setText(Sequel.cariIsi("select keluhan from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            JalannyaPenyakit.setText(Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            PemeriksaanPenunjang.setText(Sequel.cariIsi("select penilaian from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getdata_fisioterapi());
        BtnHapus.setEnabled(akses.getdata_fisioterapi());
        BtnEdit.setEnabled(akses.getdata_fisioterapi());
        BtnPrint.setEnabled(akses.getdata_fisioterapi()); 
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from fisioterapi where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
        })==true){
            tampil();
            emptTeks();
