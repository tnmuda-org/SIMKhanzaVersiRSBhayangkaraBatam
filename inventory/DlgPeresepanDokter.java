...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,psracikan,psresep,pscarikapasitas,psresepasuransi,ps2;
    private ResultSet rs,rsracikan,rsobat,carikapasitas,rs2;
    ...
    private String noracik="",aktifkanbatch="no",STOKKOSONGRESEP="no",qrystokkosong="",tampilkan_ppnobat_ralan="",status="",bangsal="",resep="",DEPOAKTIFOBAT="",
            kamar="",norawatibu="",kelas,bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),RESEPRAJALKEPLAN="no",notifwafarmasi = "", 
            idgroupwafarmasi = "", pesan = "", tanggaljamkirim = "", asalresep = "", kamarresep = "",rincianobat="";
    ...
    public DlgPeresepanDokter(java.awt.Frame parent, boolean modal) {
        ...
        try {
            notifwafarmasi = koneksiDB.NOTIFWAFARMASI();
            idgroupwafarmasi = koneksiDB.IDGROUPWAFARMASI();
        } catch (Exception e) {
            notifwafarmasi = "no";
            idgroupwafarmasi = "no";
        }
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
 ...
 /*   public void emptTeksobat() {
                    ...
                    if(STOKKOSONGRESEP.equals("no")){
                        while(rsobat.next()){
                            if(rsobat.getDouble("jml")>rsobat.getDouble("stok")){
                                ...
                                tabModeResep.addRow(new Object[] {
                                   false,"",rsobat.getString("aturan_pakai"),rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                ...
                                tabModeResep.addRow(new Object[] {
                                    false,rsobat.getDouble("jml"),rsobat.getString("aturan_pakai"),rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                    rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                                    rsobat.getString("nama"),rsobat.getString("nama_industri"),rsobat.getDouble("h_beli")
                                 }); 
                            }         
                        ...
                        while(rsobat.next()){
                            if(rsobat.getDouble("jml")>rsobat.getDouble("stok")){
                                ...
                                if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                    ...
                                    tabModeResep.addRow(new Object[] {
                                       false,"",rsobat.getString("aturan_pakai"),rsobat.getDouble("stok"),rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                       rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("kelas2"),100),
                                       rsobat.getString("nama"),rsobat.getString("nama_industri"),rsobat.getDouble("h_beli")
                                    });
                                }else if(Jeniskelas.getSelectedItem().equals("Kelas 3")){
                        ...
                        while(rsobat.next()){
                            if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                ...
                                tabModeResep.addRow(new Object[] {
                                   false,rsobat.getDouble("jml"),rsobat.getString("aturan_pakai"),rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("kelas3"),100),
                                   rsobat.getString("nama"),rsobat.getString("nama_industri"),rsobat.getDouble("stok"),rsobat.getDouble("h_beli")
                                });
                            }else if(Jeniskelas.getSelectedItem().equals("VIP")){
                                tabModeResep.addRow(new Object[] {
                                   false,rsobat.getDouble("jml"),rsobat.getString("aturan_pakai"),rsobat.getDouble("stok"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
            ...
            if(STOKKOSONGRESEP.equals("no")){
                try {
                    if(Double.parseDouble(tbResep.getValueAt(tbResep.getSelectedRow(),1).toString())>0){
                        if(Valid.SetAngka(tbResep.getValueAt(tbResep.getSelectedRow(),1).toString())>Valid.SetAngka(tbResep.getValueAt(tbResep.getSelectedRow(),3).toString())){
                            JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
    ...
    private void KirimWaFarmasi() {
        if ((tbObatResepRacikan.getSelectedRow() > -1) && (tbDetailResepObatRacikan.getSelectedRow() > -1)) {
            KirimWaFarmasiRacikan();
        } else {
            KirimWaFarmasiUmum();
        }
    }

    private void KirimWaFarmasiRacikan() {
        try {
            ...
            try {
                ...
                while (rsracikan.next()) {
                    ...
                    try {
                        ps2.setString(1, NoResep.getText());
                        ps2.setString(2, rsracikan.getString("no_racik"));
                        rs2 = ps2.executeQuery();
                        while (rs2.next()) {
                            rincianobat = "- "+rs2.getString("nama_brng") + " " + rs2.getString("jml") + " " + rs2.getString("satuan") + ",\n" + rincianobat;
                        }
                    } catch (Exception e) {
                ...
                daftarObat.append(rsracikan.getString("no_racik")).append(". ")
                                .append(rsracikan.getString("nama_racik") +"\n"+ rincianobat).append("    ")
                                .append(rsracikan.getString("aturan_pakai")).append("    ")
                                .append(rsracikan.getString("jml_dr")).append(" ")
                                .append(rsracikan.getString("metode")).append("\n");
                
                }
                asalresep = Sequel.cariIsi("select ifnull(kamar_inap.kd_kamar,'') from kamar_inap where kamar_inap.no_rawat='" + TNoRw.getText() + "' order by kamar_inap.tgl_masuk desc limit 1");
                    if (!asalresep.equals("")) {
                        kamarresep = asalresep + ", " + Sequel.cariIsi("select bangsal.nm_bangsal from bangsal inner join kamar on bangsal.kd_bangsal=kamar.kd_bangsal "
                                + " where kamar.kd_kamar='" + asalresep + "' ");
                        kamar = "Kamar";
                    } else if (asalresep.equals("")) {
                        asalresep = "Poli";
                        kamarresep = Sequel.cariIsi("select poliklinik.nm_poli from poliklinik inner join reg_periksa on poliklinik.kd_poli=reg_periksa.kd_poli "
                    ...
                    try (PreparedStatement psWa = koneksiwa.prepareStatement(
                            ...
                            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")) {
                        psWa.setLong(1, 0);
                        psWa.setString(2, idgroupwafarmasi);
    ...
    private void KirimWaFarmasiUmum() {        
        if (!tbResep.getValueAt(tbResep.getSelectedRow(), 0).toString().equals("")) {
            try {
                koneksiwa = koneksiDBWa.condb();
                ps = koneksi.prepareStatement(
                        "SELECT resep_dokter.no_resep, resep_obat.tgl_perawatan, resep_obat.jam_peresepan, "
                        + "reg_periksa.kd_pj, resep_obat.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, "
                        + "resep_obat.kd_dokter, dokter.nm_dokter "
                        + "FROM resep_obat "
                ...
                if (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "SELECT databarang.kode_brng, databarang.nama_brng, resep_dokter.jml, kodesatuan.satuan, "
                    ...
                    StringBuilder daftarObat = new StringBuilder();
                    while (rs2.next()) {
                        daftarObat.append("- ").append(rs2.getString("nama_brng")).append(" ")
                                .append(rs2.getString("aturan_pakai")).append("    ")
                                .append(rs2.getString("jml")).append(" ")
                                .append(rs2.getString("satuan")).append("\n");
                    }

                    asalresep = Sequel.cariIsi("select ifnull(kamar_inap.kd_kamar,'') from kamar_inap where kamar_inap.no_rawat='" + rs.getString("no_rawat") + "' order by kamar_inap.tgl_masuk desc limit 1");
                    if (!asalresep.equals("")) {
                        kamarresep = asalresep + ", " + Sequel.cariIsi("select bangsal.nm_bangsal from bangsal inner join kamar on bangsal.kd_bangsal=kamar.kd_bangsal "
                                + " where kamar.kd_kamar='" + asalresep + "' ");
                        kamar = "Kamar";
            ...
            JOptionPane.showMessageDialog(null, "Maaf, Gagal mengirim resep. Pilih dulu data yang mau dicetak. Klik data Nomor Resep untuk memilih...!!!!");
        }
    }
