 ...
 * @author dosen
 */
public final class DlgPeresepanDokterRalankeRanapMSani extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokterRalankeRanapMSani(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnTambahTindakan2 = new widget.Button();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Peresepan Obat Oleh Dokter Dari Rawat Jalan ke Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2024" }));
        ...
        jLabel14.setText("Riwayat Alergi:");
        jLabel14.setName("jLabel14"); // NOI18N
        jLabel14.setPreferredSize(new java.awt.Dimension(85, 23));
        FormInput.add(jLabel14);
        jLabel14.setBounds(720, 40, 85, 23);
        ...
        RiwayatAlergi.setBounds(810, 40, 300, 23);

        BtnTambahTindakan2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/plus_16.png"))); // NOI18N
        BtnTambahTindakan2.setMnemonic('3');
        BtnTambahTindakan2.setToolTipText("Alt+3");
        BtnTambahTindakan2.setName("BtnTambahTindakan2"); // NOI18N
        BtnTambahTindakan2.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnTambahTindakan2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTambahTindakan2ActionPerformed(evt);
            }
        });
        FormInput.add(BtnTambahTindakan2);
        BtnTambahTindakan2.setBounds(1110, 40, 28, 23);
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat","?,?,?,?,?,?,?,?,?,?,?","Nomer Resep",11,new String[]{
                        ...
                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),status,"0000-00-00","00:00:00",Judul.getText()
                        })==true){
                            simpandata();
                    }else{
                        emptTeksobat();
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void BtnTambahTindakan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahTindakan2ActionPerformed
    ...
    }//GEN-LAST:event_BtnTambahTindakan2ActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanDokterRalankeRanapMSani dialog = new DlgPeresepanDokterRalankeRanapMSani(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnTambahTindakan2;
