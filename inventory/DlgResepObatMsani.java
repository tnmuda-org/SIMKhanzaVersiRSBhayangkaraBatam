 ...
 * @author perpustakaan
 */
public final class DlgResepObatMsani extends javax.swing.JDialog {
    ...
    private String now=dateFormat.format(date),lembarobat="",status="",rincianobat="",finger="",kamar="",namakamar="",no_sep="",aktifkanbatch ="no";
     ...
     *@param parent
     *@param modal*/
    public DlgResepObatMsani(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        CetakBerkasKlaim = new javax.swing.JMenuItem();
        ...
        CetakBerkasKlaim.setBackground(new java.awt.Color(255, 255, 254));
        CetakBerkasKlaim.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        CetakBerkasKlaim.setForeground(new java.awt.Color(50, 50, 50));
        CetakBerkasKlaim.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        CetakBerkasKlaim.setText("Cetak Berkas Klaim Dgn Resep");
        CetakBerkasKlaim.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        CetakBerkasKlaim.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        CetakBerkasKlaim.setName("CetakBerkasKlaim"); // NOI18N
        CetakBerkasKlaim.setPreferredSize(new java.awt.Dimension(225, 25));
        CetakBerkasKlaim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CetakBerkasKlaimActionPerformed(evt);
            }
        });
        Popup2.add(CetakBerkasKlaim);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-12-2023 17:23:48" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-12-2023 17:23:48" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-12-2023" }));
        ...
        jLabel4.setBounds(730, 10, 90, 20);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void ppResepObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResepObatActionPerformed
        ...
        if(tabMode.getRowCount()==0){
        ...
        }else if(!(TPasien.getText().trim().equals("")) && (aktifkanbatch.equals("yes"))){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Map<String, Object> param = new HashMap<>();  
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResepbatch.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select DATE_FORMAT(data_batch.tgl_kadaluarsa,'%d-%m-%Y')as tgl_kadaluarsa,resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir, "+
                    "pasien.no_ktp,resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,databarang.nama_brng,"+
                    ...
                    "and data_batch.kode_brng=detail_pemberian_obat.kode_brng and data_batch.no_batch=detail_pemberian_obat.no_batch "+
                    "and data_batch.no_faktur=detail_pemberian_obat.no_faktur where resep_obat.no_resep='"+NoResep.getText()+"' and aturan_pakai.aturan<>''",param);
            }
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep2batch.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select obat_racikan.keterangan,resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir," +
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,obat_racikan.nama_racik," +
            ...
            }else if(!(TPasien.getText().trim().equals("")) && (aktifkanbatch.equals("no"))){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Map<String, Object> param = new HashMap<>();  
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir,pasien.no_ktp, "+
    ...
    private void CetakBerkasKlaimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CetakBerkasKlaimActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            ...
            try {
                ...
                psracikan=koneksi.prepareStatement(
                    ...
                    "where resep_obat.no_resep=?");
                try {
                    psracikan.setString(1,tbResep.getValueAt(tbResep.getSelectedRow(),0).toString());
                    rsracikan=psracikan.executeQuery();
                    while(rsracikan.next()){
                        rincianobat="";
                        ps2=koneksi.prepareStatement(
            ...
            param.put("propinsirs",akses.getpropinsirs());
            param.put("tanggal",tbResep.getValueAt(tbResep.getSelectedRow(),0).toString());
    ...
    }//GEN-LAST:event_CetakBerkasKlaimActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgResepObatMsani dialog = new DlgResepObatMsani(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem CetakBerkasKlaim;
