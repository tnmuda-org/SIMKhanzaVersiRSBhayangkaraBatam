...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Tgl.Penyerahan","Jam Penyerahan","No Kartu","Tanggal Lahir"
            }){
    ...
    private void initComponents() {
        ...
        PenyerahanResep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PenyerahanResep.setText("Penyerahan Obat");
        PenyerahanResep.setName("PenyerahanResep"); // NOI18N
        PenyerahanResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PenyerahanResepActionPerformed(evt);
            }
        });
        jPopupMenu1.add(PenyerahanResep);
...
*/
    ...
    private void PenyerahanResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PenyerahanResepActionPerformed
         BtnPenyerahanActionPerformed(null);
    ...
    */
    ...
    private javax.swing.JMenuItem PenyerahanResep;
    ...
    public void tampil() {
        ...
        try{  
            ...
            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " if(resep_obat.jam_penyerahan='00:00:00','',resep_obat.jam_penyerahan) as jam_penyerahan,pasien.no_peserta,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as tgl_lahir from resep_obat "+
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                        tabMode.addRow(new String[]{
                            ...
                            rs.getString("no_peserta"),rs.getString("tgl_lahir")
                        });              
                    }  
                }else{
                    while(rs.next()){
