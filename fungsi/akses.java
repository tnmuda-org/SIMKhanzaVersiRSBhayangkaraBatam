...
public final class akses {
    ...
    private static boolean aktif=true,admin=true,user=true,vakum=true,aplikasi=true,penyakit=true,obat_penyakit=true,dokter=true,jadwal_praktek=true,petugas=true,pasien=true,registrasi=true,
            tindakan_ralan=true,kamar_inap=true,tindakan_ranap=true,operasi=true,rujukan_keluar=true,rujukan_masuk=true,beri_obat=true,
            resep_pulang=true,pasien_meninggal=true,diet_pasien=true,kelahiran_bayi=true,periksa_lab=true,periksa_radiologi=true,
            kasir_ralan=true,deposit_pasien=true,piutang_pasien=true,peminjaman_berkas=true,barcode=true,presensi_harian=true,
            presensi_bulanan=true,pegawai_admin=true,pegawai_user=true,suplier=true,satuan_barang=true,konversi_satuan=true,jenis_barang=true,
            obat=true,stok_opname_obat=true,stok_obat_pasien=true,pengadaan_obat=true,pemesanan_obat=true,penjualan_obat=true,piutang_obat=true,
            retur_ke_suplier=true,retur_dari_pembeli=true,retur_obat_ranap=true,retur_piutang_pasien=true,keuntungan_penjualan=true,keuntungan_beri_obat=true,
            sirkulasi_obat=true,ipsrs_barang=true,ipsrs_jenis_barang=true,ipsrs_pengadaan_barang=true,ipsrs_stok_keluar=true,ipsrs_rekap_pengadaan=true,ipsrs_rekap_stok_keluar=true,
            ipsrs_pengeluaran_harian=true,inventaris_jenis=true,inventaris_kategori=true,inventaris_merk=true,inventaris_ruang=true,inventaris_produsen=true,
            inventaris_koleksi=true,inventaris_inventaris=true,inventaris_sirkulasi=true,parkir_jenis=true,parkir_in=true,parkir_out=true,
            parkir_rekap_harian=true,parkir_rekap_bulanan=true,informasi_kamar=true,harian_tindakan_poli=true,obat_per_poli=true,obat_per_kamar=true,
            obat_per_dokter_ralan=true,obat_per_dokter_ranap=true,harian_dokter=true,bulanan_dokter=true,harian_paramedis=true,bulanan_paramedis=true,
            pembayaran_ralan=true,pembayaran_ranap=true,rekap_pembayaran_ralan=true,rekap_pembayaran_ranap=true,tagihan_masuk=true,tambahan_biaya=true,
            potongan_biaya=true,resep_obat=true,resume_pasien=true,fisioterapi=true,penyakit_ralan=true,penyakit_ranap=true,kamar=true,tarif_ralan=true,tarif_ranap=true,
            tarif_lab=true,tarif_radiologi=true,tarif_operasi=true,akun_rekening=true,rekening_tahun=true,posting_jurnal=true,buku_besar=true,
            cashflow=true,keuangan=true,pengeluaran=true,setup_pjlab=true,setup_otolokasi=true,setup_jam_kamin=true,setup_embalase=true,tracer_login=true,
            display=true,set_harga_obat=true,set_penggunaan_tarif=true,set_oto_ralan=true,biaya_harian=true,biaya_masuk_sekali=true,set_no_rm=true,
            billing_ralan=true,billing_ranap=true,status=true,jm_ranap_dokter=true,igd=true,barcoderalan=true,barcoderanap=true,set_harga_obat_ralan=true,
            set_harga_obat_ranap=true,penyakit_pd3i=true,surveilans_pd3i=true,surveilans_ralan=true,diagnosa_pasien=true,surveilans_ranap=true,
            pny_takmenular_ranap=true,pny_takmenular_ralan=true,kunjungan_ralan=true,rl32=true,rl33=true,rl37=true,rl38=true,harian_tindakan_dokter=true,
            sms=true,sidikjari=true,jam_masuk=true,jadwal_pegawai=true,parkir_barcode=true,set_nota=true,dpjp_ranap=true,mutasi_barang=true,rl34=true,rl36=true,
            fee_visit_dokter=true,fee_bacaan_ekg=true,fee_rujukan_rontgen=true,fee_rujukan_ranap=true,fee_ralan=true,akun_bayar=true,bayar_pemesanan_obat=true,
            obat_per_dokter_peresep=true,pemasukan_lain=true,pengaturan_rekening=true,closing_kasir=true,keterlambatan_presensi=true,set_harga_kamar=true,
            rekap_per_shift=true,bpjs_cek_nik=true,bpjs_cek_kartu=true,bpjs_cek_riwayat=true,obat_per_cara_bayar=true,kunjungan_ranap=true,bayar_piutang=true,
            payment_point=true,bpjs_cek_nomor_rujukan=true,icd9=true,darurat_stok=true,retensi_rm=true,temporary_presensi=true,jurnal_harian=true,
            sirkulasi_obat2=true,edit_registrasi=true,bpjs_referensi_diagnosa=true,bpjs_referensi_poli=true,industrifarmasi=true,harian_js=true,bulanan_js=true,
            harian_paket_bhp=true,bulanan_paket_bhp=true,piutang_pasien2=true,bpjs_referensi_faskes=true,bpjs_sep=true,pengambilan_utd=true,tarif_utd=true,
            pengambilan_utd2=true,utd_medis_rusak=true,pengambilan_penunjang_utd=true,pengambilan_penunjang_utd2=true,utd_penunjang_rusak=true,
            suplier_penunjang=true,utd_donor=true,bpjs_monitoring_klaim=true,utd_cekal_darah=true,utd_komponen_darah=true,utd_stok_darah=true,
            utd_pemisahan_darah=true,harian_kamar=true,rincian_piutang_pasien=true,keuntungan_beri_obat_nonpiutang=true,reklasifikasi_ralan=true,
            reklasifikasi_ranap=true,utd_penyerahan_darah=true,hutang_obat=true,riwayat_obat_alkes_bhp=true,sensus_harian_poli=true,rl4a=true,
            aplicare_referensi_kamar=true,aplicare_ketersediaan_kamar=true,inacbg_klaim_baru_otomatis=true,inacbg_klaim_baru_manual=true,inacbg_coder_nik=true,
            mutasi_berkas=true,akun_piutang=true,harian_kso=true,bulanan_kso=true,harian_menejemen=true,bulanan_menejemen=true,inhealth_cek_eligibilitas=true,
            inhealth_referensi_jenpel_ruang_rawat=true,inhealth_referensi_poli=true,inhealth_referensi_faskes=true,inhealth_sjp=true,piutang_ralan=true,
            piutang_ranap=true,detail_piutang_penjab=true,lama_pelayanan_ralan=true,catatan_pasien=true,rl4b=true,rl4asebab=true,rl4bsebab=true,
            data_HAIs=true,harian_HAIs=true,bulanan_HAIs=true,hitung_bor=true,perusahaan_pasien=true,resep_dokter=true,lama_pelayanan_apotek=true,
            hitung_alos=true,detail_tindakan=true,rujukan_poli_internal=true,rekap_poli_anak=true,grafik_kunjungan_poli=true,grafik_kunjungan_perdokter=true,
            grafik_kunjungan_perpekerjaan=true,grafik_kunjungan_perpendidikan=true,grafik_kunjungan_pertahun=true,berkas_digital_perawatan=true,
            penyakit_menular_ranap=true,penyakit_menular_ralan=true,grafik_kunjungan_perbulan=true,grafik_kunjungan_pertanggal=true,grafik_kunjungan_demografi=true,
            grafik_kunjungan_statusdaftartahun=true,grafik_kunjungan_statusdaftartahun2=true,grafik_kunjungan_statusdaftarbulan=true,grafik_kunjungan_statusdaftarbulan2=true,
            grafik_kunjungan_statusdaftartanggal=true,grafik_kunjungan_statusdaftartanggal2=true,grafik_kunjungan_statusbataltahun=true,grafik_kunjungan_statusbatalbulan=true,
            pcare_cek_penyakit=true,grafik_kunjungan_statusbataltanggal=true,kategori_barang=true,golongan_barang=true,pemberian_obat_pertanggal=true,
            penjualan_obat_pertanggal=true,pcare_cek_kesadaran=true,pembatalan_periksa_dokter=true,pembayaran_per_unit=true,rekap_pembayaran_per_unit=true,
            grafik_kunjungan_percarabayar=true,ipsrs_pengadaan_pertanggal=true,ipsrs_stokkeluar_pertanggal=true,grafik_kunjungan_ranaptahun=true,
            pcare_cek_rujukan=true,grafik_lab_ralantahun=true,grafik_rad_ralantahun=true,cek_entry_ralan=true,inacbg_klaim_baru_manual2=true,
            permintaan_medis=true,rekap_permintaan_medis=true,surat_pemesanan_medis=true,permintaan_non_medis=true,rekap_permintaan_non_medis=true,
            surat_pemesanan_non_medis=true,grafik_per_perujuk=true,bpjs_cek_prosedur=true,bpjs_cek_kelas_rawat=true,bpjs_cek_dokter=true,
            bpjs_cek_spesialistik=true,bpjs_cek_ruangrawat=true,bpjs_cek_carakeluar=true,bpjs_cek_pasca_pulang=true,detail_tindakan_okvk=true,
            billing_parsial=true,bpjs_cek_nomor_rujukan_rs=true,bpjs_cek_rujukan_kartu_pcare=true,bpjs_cek_rujukan_kartu_rs=true,akses_depo_obat=true,
            bpjs_rujukan_keluar=true,grafik_lab_ralanbulan=true,pengeluaran_stok_apotek=true,grafik_rad_ralanbulan=true,detailjmdokter2=true,
            pengaduan_pasien=true,grafik_lab_ralanhari=true,grafik_rad_ralanhari=true,sensus_harian_ralan=true,metode_racik=true,pembayaran_akun_bayar=true,
            pengguna_obat_resep=true,rekap_pemesanan=true,master_berkas_pegawai=true,berkas_kepegawaian=true,riwayat_jabatan=true,riwayat_pendidikan=true,
            riwayat_naik_gaji=true,kegiatan_ilmiah=true,riwayat_penghargaan=true,riwayat_penelitian=true,penerimaan_non_medis=true,bayar_pesan_non_medis=true,
            hutang_barang_non_medis=true,rekap_pemesanan_non_medis=true,insiden_keselamatan=true,insiden_keselamatan_pasien=true,grafik_ikp_pertahun=true,
            grafik_ikp_perbulan=true,grafik_ikp_pertanggal=true,riwayat_data_batch=true,grafik_ikp_jenis=true,grafik_ikp_dampak=true,piutang_akun_piutang=true,
            grafik_kunjungan_per_agama=true,grafik_kunjungan_per_umur=true,suku_bangsa=true,bahasa_pasien=true,golongan_tni=true,satuan_tni=true,
            jabatan_tni=true,pangkat_tni=true,golongan_polri=true,satuan_polri=true,jabatan_polri=true,pangkat_polri=true,cacat_fisik=true,
            grafik_kunjungan_suku=true,grafik_kunjungan_bahasa=true,booking_operasi=true,mapping_poli_bpjs=true,grafik_kunjungan_per_cacat=true,
            barang_cssd=true,skdp_bpjs=true,booking_registrasi=true,bpjs_cek_propinsi=true,bpjs_cek_kabupaten=true,bpjs_cek_kecamatan=true,
            bpjs_cek_dokterdpjp=true,bpjs_cek_riwayat_rujukanrs=true,bpjs_cek_tanggal_rujukan=true,permintaan_lab=true,permintaan_radiologi=true,
            surat_indeks=true,surat_map=true,surat_almari=true,surat_rak=true,surat_ruang=true,surat_klasifikasi=true,surat_status=true,
            surat_sifat=true,surat_balas=true,surat_masuk=true,pcare_cek_dokter=true,pcare_cek_poli=true,pcare_cek_provider=true,
            pcare_cek_statuspulang=true,pcare_cek_spesialis=true,pcare_cek_subspesialis=true,pcare_cek_sarana=true,pcare_cek_khusus=true,
            pcare_cek_obat=true,pcare_cek_tindakan=true,pcare_cek_faskessubspesialis=true,pcare_cek_faskesalihrawat=true,
            pcare_cek_faskesthalasemia=true,pcare_mapping_obat=true,pcare_mapping_tindakan=true,pcare_club_prolanis=true,
            pcare_mapping_poli=true,pcare_kegiatan_kelompok=true,pcare_mapping_tindakan_ranap=true,pcare_peserta_kegiatan_kelompok=true,
            sirkulasi_obat3=true,bridging_pcare_daftar=true,pcare_mapping_dokter=true,ranap_per_ruang=true,penyakit_ranap_cara_bayar=true,
            anggota_militer_dirawat=true,set_input_parsial=true,lama_pelayanan_radiologi=true,lama_pelayanan_lab=true,bpjs_cek_sep=true,
            catatan_perawatan=true,surat_keluar=true,kegiatan_farmasi=true,stok_opname_logistik=true,sirkulasi_non_medis=true,
            rekap_lab_pertahun=true,perujuk_lab_pertahun=true,rekap_radiologi_pertahun=true,perujuk_radiologi_pertahun=true,
            jumlah_porsi_diet=true,jumlah_macam_diet=true,payment_point2=true,pembayaran_akun_bayar2=true,hapus_nota_salah=true,
            hais_perbangsal=true,ppn_obat=true,saldo_akun_perbulan=true,display_apotek=true,sisrute_referensi_faskes=true,
            sisrute_referensi_alasanrujuk=true,sisrute_referensi_diagnosa=true,sisrute_rujukan_masuk=true,sisrute_rujukan_keluar=true,
            bpjs_cek_skdp=true,data_batch=true,kunjungan_permintaan_lab=true,kunjungan_permintaan_lab2=true,kunjungan_permintaan_radiologi=true,
            kunjungan_permintaan_radiologi2=true,pcare_pemberian_obat=true,pcare_pemberian_tindakan=true,pembayaran_akun_bayar3=true,
            password_asuransi=true,kemenkes_sitt=true,siranap_ketersediaan_kamar=true,grafik_tb_periodelaporan=true,grafik_tb_rujukan=true,
            grafik_tb_riwayat=true,grafik_tb_tipediagnosis=true,grafik_tb_statushiv=true,grafik_tb_skoringanak=true,grafik_tb_konfirmasiskoring5=true,
            grafik_tb_konfirmasiskoring6=true,grafik_tb_sumberobat=true,grafik_tb_hasilakhirpengobatan=true,grafik_tb_hasilteshiv=true,
            kadaluarsa_batch=true,sisa_stok=true,obat_per_resep=true,pemakaian_air_pdam=true,limbah_b3_medis=true,grafik_air_pdam_pertanggal=true,
            grafik_air_pdam_perbulan=true,grafik_limbahb3_pertanggal=true,grafik_limbahb3_perbulan=true,limbah_domestik=true,
            grafik_limbahdomestik_pertanggal=true,grafik_limbahdomestik_perbulan=true,mutu_air_limbah=true,pest_control=true,ruang_perpustakaan=true,
            kategori_perpustakaan=true,jenis_perpustakaan=true,pengarang_perpustakaan=true,penerbit_perpustakaan=true,koleksi_perpustakaan=true,
            inventaris_perpustakaan=true,set_peminjaman_perpustakaan=true,denda_perpustakaan=true,anggota_perpustakaan=true,
            peminjaman_perpustakaan=true,bayar_denda_perpustakaan=true,ebook_perpustakaan=true,jenis_cidera_k3rs=true,penyebab_k3rs=true,
            jenis_luka_k3rs=true,lokasi_kejadian_k3rs=true,dampak_cidera_k3rs=true,jenis_pekerjaan_k3rs=true,bagian_tubuh_k3rs=true,
            peristiwa_k3rs=true,grafik_k3_pertahun=true,grafik_k3_perbulan=true,grafik_k3_pertanggal=true,grafik_k3_perjeniscidera=true,
            grafik_k3_perpenyebab=true,grafik_k3_perjenisluka=true,grafik_k3_lokasikejadian=true,grafik_k3_dampakcidera=true,
            grafik_k3_perjenispekerjaan=true,grafik_k3_perbagiantubuh=true,jenis_cidera_k3rstahun=true,penyebab_k3rstahun=true,
            jenis_luka_k3rstahun=true,lokasi_kejadian_k3rstahun=true,dampak_cidera_k3rstahun=true,jenis_pekerjaan_k3rstahun=true,
            bagian_tubuh_k3rstahun=true,sekrining_rawat_jalan=true,bpjs_histori_pelayanan=true,rekap_mutasi_berkas=true,
            skrining_ralan_pernapasan_pertahun=true,pengajuan_barang_medis=true,pengajuan_barang_nonmedis=true,grafik_kunjungan_ranapbulan=true,
            grafik_kunjungan_ranaptanggal=true,grafik_kunjungan_ranap_peruang=true,kunjungan_bangsal_pertahun=true,grafik_jenjang_jabatanpegawai=true,
            grafik_bidangpegawai=true,grafik_departemenpegawai=true,grafik_pendidikanpegawai=true,grafik_sttswppegawai=true,
            grafik_sttskerjapegawai=true,grafik_sttspulangranap=true,kip_pasien_ranap=true,kip_pasien_ralan=true,bpjs_mapping_dokterdpjp=true,
            data_triase_igd=true,master_triase_skala1=true,master_triase_skala2=true,master_triase_skala3=true,master_triase_skala4=true,
            master_triase_skala5=true,master_triase_pemeriksaan=true,master_triase_macamkasus=true,rekap_permintaan_diet=true,daftar_pasien_ranap=true,
            daftar_pasien_ranaptni=true,pengajuan_asetinventaris=true,item_apotek_jenis=true,item_apotek_kategori=true,item_apotek_golongan=true,
            item_apotek_industrifarmasi=true,obat10_terbanyak_poli=true,grafik_pengajuan_aset_urgensi=true,grafik_pengajuan_aset_status=true,
            grafik_pengajuan_aset_departemen=true,rekap_pengajuan_aset_departemen=true,grafik_kelompok_jabatanpegawai=true,grafik_resiko_kerjapegawai=true,
            grafik_emergency_indexpegawai=true,grafik_inventaris_ruang=true,harian_HAIs2=true,grafik_inventaris_jenis=true,data_resume_pasien=true,data_fisioterapi=true,
            perkiraan_biaya_ranap=true,rekap_obat_poli=true,rekap_obat_pasien=true,grafik_HAIs_pasienbangsal=true,grafik_HAIs_pasienbulan=true,
            permintaan_perbaikan_inventaris=true,grafik_HAIs_laju_vap=true,grafik_HAIs_laju_iad=true,grafik_HAIs_laju_pleb=true,grafik_HAIs_laju_isk=true,
            grafik_HAIs_laju_ilo=true,grafik_HAIs_laju_hap=true,inhealth_mapping_poli=true,inhealth_mapping_dokter=true,inhealth_mapping_tindakan_ralan=true,
            inhealth_mapping_tindakan_ranap=true,inhealth_mapping_tindakan_radiologi=true,inhealth_mapping_tindakan_laborat=true,
            inhealth_mapping_tindakan_operasi=true,hibah_obat_bhp=true,asal_hibah=true,asuhan_gizi=true,inhealth_kirim_tagihan=true,
            sirkulasi_obat4=true,sirkulasi_obat5=true,sirkulasi_non_medis2=true,monitoring_asuhan_gizi=true,penerimaan_obat_perbulan=true,
            rekap_kunjungan=true,surat_sakit=true,penilaian_awal_keperawatan_ralan=true,permintaan_diet=true,master_masalah_keperawatan=true,
            pengajuan_cuti=true,kedatangan_pasien=true,utd_pendonor=true,toko_suplier=true,toko_jenis=true,toko_set_harga=true,
            toko_barang=true,penagihan_piutang_pasien=true,akun_penagihan_piutang=true,stok_opname_toko=true,toko_riwayat_barang=true,
            toko_surat_pemesanan=true,toko_pengajuan_barang=true,toko_penerimaan_barang=true,toko_pengadaan_barang=true,toko_hutang=true,
            toko_bayar_pemesanan=true,toko_member=true,toko_penjualan=true,registrasi_poli_per_tanggal=true,toko_piutang=true,toko_retur_beli=true,
            ipsrs_returbeli=true,ipsrs_riwayat_barang=true,pasien_corona=true,toko_pendapatan_harian=true,diagnosa_pasien_corona=true,
            perawatan_pasien_corona=true,penilaian_awal_keperawatan_gigi=true,master_masalah_keperawatan_gigi=true,toko_bayar_piutang=true,
            toko_piutang_harian=true,toko_penjualan_harian=true,deteksi_corona=true,penilaian_awal_keperawatan_kebidanan=true,pengumuman_epasien=true,
            surat_hamil=true,set_tarif_online=true,booking_periksa=true,toko_sirkulasi=true,toko_retur_jual=true,toko_retur_piutang=true,
            toko_sirkulasi2=true,toko_keuntungan_barang=true,zis_pengeluaran_penerima_dankes=true,zis_penghasilan_penerima_dankes=true,
            zis_ukuran_rumah_penerima_dankes=true,zis_dinding_rumah_penerima_dankes=true,zis_lantai_rumah_penerima_dankes=true,
            zis_atap_rumah_penerima_dankes=true,zis_kepemilikan_rumah_penerima_dankes=true,zis_kamar_mandi_penerima_dankes=true,
            zis_dapur_rumah_penerima_dankes=true,zis_kursi_rumah_penerima_dankes=true,zis_kategori_phbs_penerima_dankes=true,
            zis_elektronik_penerima_dankes=true,zis_ternak_penerima_dankes=true,zis_jenis_simpanan_penerima_dankes=true,penilaian_awal_keperawatan_anak=true,
            zis_kategori_asnaf_penerima_dankes=true,master_masalah_keperawatan_anak=true,master_imunisasi=true,zis_patologis_penerima_dankes=true,
            pcare_cek_kartu=true,surat_bebas_narkoba=true,surat_keterangan_covid=true,pemakaian_air_tanah=true,grafik_air_tanah_pertanggal=true,
            grafik_air_tanah_perbulan=true,lama_pelayanan_poli=true,hemodialisa=true,grafik_harian_hemodialisa=true,grafik_bulanan_hemodialisa=true,
            grafik_tahunan_hemodialisa=true,grafik_bulanan_meninggal=true,laporan_tahunan_irj=true,perbaikan_inventaris=true,surat_cuti_hamil=true,
            permintaan_stok_obat_pasien=true,pemeliharaan_inventaris=true,klasifikasi_pasien_ranap=true,bulanan_klasifikasi_pasien_ranap,
            harian_klasifikasi_pasien_ranap=true,klasifikasi_pasien_perbangsal=true,soap_perawatan=true,klaim_rawat_jalan=true,
            skrining_gizi=true,lama_penyiapan_rm=true,dosis_radiologi=true,demografi_umur_kunjungan=true,jam_diet_pasien=true,
            rvu_bpjs=true,verifikasi_penerimaan_farmasi=true,verifikasi_penerimaan_logistik=true,pemeriksaan_lab_pa=true,ringkasan_pengajuan_obat=true,
            ringkasan_pemesanan_obat=true,ringkasan_pengadaan_obat=true,ringkasan_penerimaan_obat=true,ringkasan_hibah_obat=true,
            ringkasan_penjualan_obat=true,ringkasan_beri_obat=true,ringkasan_piutang_obat=true,ringkasan_stok_keluar_obat=true,
            ringkasan_retur_suplier_obat=true,ringkasan_retur_pembeli_obat=true,penilaian_awal_keperawatan_ranapkebidanan=true,
            ringkasan_pengajuan_nonmedis=true,ringkasan_pemesanan_nonmedis=true,ringkasan_pengadaan_nonmedis=true,ringkasan_penerimaan_nonmedis=true,
            ringkasan_stokkeluar_nonmedis=true,ringkasan_returbeli_nonmedis=true,omset_penerimaan=true,validasi_penagihan_piutang=true,
            permintaan_ranap=true,bpjs_diagnosa_prb=true,bpjs_obat_prb=true,bpjs_surat_kontrol=true,penggunaan_bhp_ok=true,surat_keterangan_rawat_inap=true,
            surat_keterangan_sehat=true,surat_keterangan_terbang=true,pendapatan_per_carabayar=true,akun_host_to_host_bank_jateng=true,pembayaran_bank_jateng=true,
            bpjs_surat_pri=true,ringkasan_tindakan=true,lama_pelayanan_pasien=true,surat_sakit_pihak_2=true,tagihan_hutang_obat=true,
            referensi_mobilejkn_bpjs=true,batal_pendaftaran_mobilejkn_bpjs=true,lama_operasi=true,grafik_inventaris_kategori=true,grafik_inventaris_merk=true,
            grafik_inventaris_produsen=true,pengembalian_deposit_pasien=true,validasi_tagihan_hutang_obat=true,piutang_obat_belum_lunas=true,
            integrasi_briapi=true,pengadaan_aset_inventaris=true,akun_aset_inventaris=true,suplier_inventaris=true,penerimaan_aset_inventaris=true,
            bayar_pemesanan_iventaris=true,hutang_aset_inventaris=true,hibah_aset_inventaris=true,titip_faktur_non_medis=true,validasi_tagihan_non_medis=true,
            titip_faktur_aset=true,validasi_tagihan_aset=true,hibah_non_medis=true,pcare_alasan_tacc=true,resep_luar=true,surat_bebas_tbc=true,
            surat_buta_warna=true,surat_bebas_tato=true,surat_kewaspadaan_kesehatan=true,grafik_porsidiet_pertanggal=true,grafik_porsidiet_perbulan=true,
            grafik_porsidiet_pertahun=true,grafik_porsidiet_perbangsal=true,penilaian_awal_medis_ralan=true,master_masalah_keperawatan_mata=true,
            penilaian_awal_keperawatan_mata=true,penilaian_awal_medis_ranap=true,penilaian_awal_medis_ranap_kebidanan=true,penilaian_awal_medis_ralan_kebidanan=true,
            penilaian_awal_medis_igd=true,penilaian_awal_medis_ralan_anak=true,bpjs_referensi_poli_hfis=true,bpjs_referensi_dokter_hfis=true,
            bpjs_referensi_jadwal_hfis=true,penilaian_fisioterapi=true,bpjs_program_prb=true,bpjs_suplesi_jasaraharja=true,bpjs_data_induk_kecelakaan=true,
            bpjs_sep_internal=true,bpjs_klaim_jasa_raharja=true,bpjs_daftar_finger_print=true,bpjs_rujukan_khusus=true,pemeliharaan_gedung=true,
            grafik_perbaikan_inventaris_pertanggal=true,grafik_perbaikan_inventaris_perbulan=true,grafik_perbaikan_inventaris_pertahun=true,
            grafik_perbaikan_inventaris_perpelaksana_status=true,penilaian_mcu=true,peminjam_piutang=true,piutang_lainlain=true,cara_bayar=true,
            audit_kepatuhan_apd=true,bpjs_task_id=true,bayar_piutang_lain=true,pembayaran_akun_bayar4=true,stok_akhir_farmasi_pertanggal=true,
            riwayat_kamar_pasien=true,uji_fungsi_kfr=true,hapus_berkas_digital_perawatan=true,kategori_pengeluaran_harian=true,kategori_pemasukan_lain=true,
            pembayaran_akun_bayar5=true,ruang_ok=true,jasa_tindakan_pasien=true,telaah_resep=true,permintaan_resep_pulang=true,rekap_jm_dokter=true,
            status_data_rm=true,ubah_petugas_lab_pk=true,ubah_petugas_lab_pa=true,ubah_petugas_radiologi=true,gabung_norawat=true,gabung_rm=true,
            ringkasan_biaya_obat_pasien_pertanggal=true,master_masalah_keperawatan_igd=true,penilaian_awal_keperawatan_igd=true,bpjs_referensi_dpho_apotek=true,
            bpjs_referensi_poli_apotek=true,bayar_jm_dokter=true,bpjs_referensi_faskes_apotek=true,bpjs_referensi_spesialistik_apotek=true,
            pembayaran_briva=true,penilaian_awal_keperawatan_ranap=true,nilai_penerimaan_vendor_farmasi_perbulan=true,akun_bayar_hutang=true,
            master_rencana_keperawatan=true,laporan_tahunan_igd=true,obat_bhp_tidakbergerak=true,ringkasan_hutang_vendor_farmasi=true,
            nilai_penerimaan_vendor_nonmedis_perbulan=true,ringkasan_hutang_vendor_nonmedis=true,anggota_polri_dirawat=true,daftar_pasien_ranap_polri=true,
            soap_ralan_polri=true,soap_ranap_polri=true,laporan_penyakit_polri=true,master_rencana_keperawatan_anak=true,jumlah_pengunjung_ralan_polri=true,
            catatan_observasi_igd=true,catatan_observasi_ranap=true,catatan_observasi_ranap_kebidanan=true,catatan_observasi_ranap_postpartum=true,
            penilaian_awal_medis_ralan_tht=true,penilaian_psikologi=true,audit_cuci_tangan_medis=true,audit_pembuangan_limbah=true,ruang_audit_kepatuhan=true,
            audit_pembuangan_benda_tajam=true,audit_penanganan_darah=true,audit_pengelolaan_linen_kotor=true,audit_penempatan_pasien=true,
            audit_kamar_jenazah=true,audit_bundle_iadp=true,audit_bundle_ido=true,audit_fasilitas_kebersihan_tangan=true,audit_fasilitas_apd=true,
            audit_pembuangan_limbah_cair_infeksius=true,audit_sterilisasi_alat=true,penilaian_awal_medis_ralan_psikiatri=true,persetujuan_penolakan_tindakan=true,
            audit_bundle_isk=true,audit_bundle_plabsi=true,audit_bundle_vap=true,akun_host_to_host_bank_papua=true,pembayaran_bank_papua=true,
            penilaian_awal_medis_ralan_penyakit_dalam=true,penilaian_awal_medis_ralan_mata=true,penilaian_awal_medis_ralan_neurologi=true,sirkulasi_obat6=true,
            penilaian_awal_medis_ralan_orthopedi=true,penilaian_awal_medis_ralan_bedah=true,integrasi_khanza_health_services=true,soap_ralan_tni=true,
            soap_ranap_tni=true,jumlah_pengunjung_ralan_tni=true,laporan_penyakit_tni=true,catatan_keperawatan_ranap=true,master_rencana_keperawatan_gigi=true,
            master_rencana_keperawatan_mata=true,master_rencana_keperawatan_igd=true,master_masalah_keperawatan_psikiatri=true,master_rencana_keperawatan_psikiatri=true,
            penilaian_awal_keperawatan_psikiatri=true,pemantauan_pews_anak=true,surat_pulang_atas_permintaan_sendiri=true,template_hasil_radiologi=true,
            laporan_bulanan_irj=true,template_pemeriksaan=true,pemeriksaan_lab_mb=true,ubah_petugas_lab_mb=true,penilaian_pre_operasi=true,penilaian_pre_anestesi=true,
            perencanaan_pemulangan=true,penilaian_lanjutan_resiko_jatuh_dewasa=true,penilaian_lanjutan_resiko_jatuh_anak=true,penilaian_awal_medis_ralan_geriatri=true,
            penilaian_tambahan_pasien_geriatri=true,skrining_nutrisi_dewasa=true,skrining_nutrisi_lansia=true,hasil_pemeriksaan_usg=true,skrining_nutrisi_anak=true,
            akun_host_to_host_bank_jabar=true,pembayaran_bank_jabar=true,surat_pernyataan_pasien_umum=true,konseling_farmasi=true,pelayanan_informasi_obat=true,
            jawaban_pio_apoteker=true,surat_persetujuan_umum=true,transfer_pasien_antar_ruang=true,satu_sehat_referensi_dokter=true,satu_sehat_referensi_pasien=true,
            satu_sehat_mapping_departemen=true,satu_sehat_mapping_lokasi=true,satu_sehat_kirim_encounter=true,catatan_cek_gds=true,satu_sehat_kirim_condition=true,
            checklist_pre_operasi=true,satu_sehat_kirim_observationttv=true,signin_sebelum_anestesi=true,satu_sehat_kirim_procedure=true,operasi_per_bulan=true,
            timeout_sebelum_insisi=true,signout_sebelum_menutup_luka=true,dapur_barang=true,dapur_opname=true,satu_sehat_mapping_vaksin=true,dapur_suplier=true,
            satu_sehat_kirim_Immunization=true,checklist_post_operasi=true,dapur_pembelian=true,dapur_stok_keluar=true,dapur_riwayat_barang=true,permintaan_dapur=true,
            rekonsiliasi_obat=true,biaya_pengadaan_dapur=true,rekap_pengadaan_dapur=true,kesling_limbah_b3medis_cair=true,grafik_limbahb3cair_pertanggal=true,
            grafik_limbahb3cair_perbulan=true,rekap_biaya_registrasi=true,konfirmasi_rekonsiliasi_obat=true,satu_sehat_kirim_clinicalimpression=true,
            penilaian_pasien_terminal=true,surat_persetujuan_rawat_inap=true,monitoring_reaksi_tranfusi=true,penilaian_korban_kekerasan=true,
            penilaian_lanjutan_resiko_jatuh_lansia=true,mpp_skrining=true,penilaian_pasien_penyakit_menular=true,edukasi_pasien_keluarga_rj=true,pemantauan_pews_dewasa=true,
            penilaian_tambahan_bunuh_diri=true,bpjs_antrean_pertanggal=true,penilaian_tambahan_perilaku_kekerasan=true,penilaian_tambahan_beresiko_melarikan_diri=true,
            persetujuan_penundaan_pelayanan=true,sisa_diet_pasien=true,penilaian_awal_medis_ralan_bedah_mulut=true,penilaian_pasien_keracunan=true,
            pemantauan_meows_obstetri=true,catatan_adime_gizi=true,pengajuan_biaya=true,penilaian_awal_keperawatan_ralan_geriatri=true,master_masalah_keperawatan_geriatri=true,
            master_rencana_keperawatan_geriatri=true,checklist_kriteria_masuk_hcu=true,checklist_kriteria_keluar_hcu=true,penilaian_risiko_dekubitus=true,
            master_menolak_anjuran_medis=true,penolakan_anjuran_medis=true,laporan_tahunan_penolakan_anjuran_medis=true,template_laporan_operasi=true,hasil_tindakan_eswl=true,
            checklist_kriteria_masuk_icu=true,checklist_kriteria_keluar_icu=true,akses_dokter_lain_rawat_jalan=true,follow_up_dbd=true,penilaian_risiko_jatuh_neonatus=true,
            persetujuan_pengajuan_biaya=true,pemeriksaan_fisik_ralan_per_penyakit=true,penilaian_lanjutan_resiko_jatuh_geriatri=true,pemantauan_ews_neonatus=true,
            validasi_persetujuan_pengajuan_biaya=true,riwayat_perawatan_icare_bpjs=true,rekap_pengajuan_biaya=true,penilaian_awal_medis_ralan_kulit_kelamin=true,
            akun_host_to_host_bank_mandiri=true,penilaian_medis_hemodialisa=true,penilaian_level_kecemasan_ranap_anak=true,penilaian_lanjutan_resiko_jatuh_psikiatri=true,
            penilaian_lanjutan_skrining_fungsional=true,penilaian_medis_ralan_rehab_medik=true,laporan_anestesi=true,template_persetujuan_penolakan_tindakan=true,
            penilaian_medis_ralan_gawat_darurat_psikiatri=true,bpjs_referensi_setting_apotek=true,bpjs_referensi_obat_apotek=true,bpjs_mapping_obat_apotek=true,
            pembayaran_bank_mandiri=true,penilaian_ulang_nyeri=true,penilaian_terapi_wicara=true,bpjs_obat_23hari_apotek=true,pengkajian_restrain=true,
            bpjs_kunjungan_sep_apotek=true,bpjs_monitoring_klaim_apotek=true,bpjs_daftar_pelayanan_obat_apotek=true,penilaian_awal_medis_ralan_paru=true,
            catatan_keperawatan_ralan=true,catatan_persalinan=true,skor_aldrette_pasca_anestesi=true,skor_steward_pasca_anestesi=true,skor_bromage_pasca_anestesi=true,
            penilaian_pre_induksi=true,hasil_usg_urologi=true,hasil_usg_gynecologi=true,hasil_pemeriksaan_ekg=true,hapus_edit_sep_bpjs=true,satu_sehat_kirim_diet=true,
            satu_sehat_mapping_obat=true,dapur_ringkasan_pembelian=true,satu_sehat_kirim_medication=true,satu_sehat_kirim_medicationrequest=true,
            penatalaksanaan_terapi_okupasi=true,satu_sehat_kirim_medicationdispense=true,hasil_usg_neonatus=true,hasil_endoskopi_faring_laring=true,
            satu_sehat_mapping_radiologi=true,satu_sehat_kirim_servicerequest_radiologi=true,hasil_endoskopi_hidung=true,satu_sehat_kirim_specimen_radiologi=true,
            master_masalah_keperawatan_neonatus=true,master_rencana_keperawatan_neonatus=true,penilaian_awal_keperawatan_ranap_neonatus=true,
            satu_sehat_kirim_observation_radiologi=true,satu_sehat_kirim_diagnosticreport_radiologi=true,hasil_endoskopi_telinga=true,satu_sehat_mapping_lab=true,
            satu_sehat_kirim_servicerequest_lab=true,satu_sehat_kirim_servicerequest_labmb=true,satu_sehat_kirim_specimen_lab=true,satu_sehat_kirim_specimen_labmb=true,
            satu_sehat_kirim_observation_lab=true,satu_sehat_kirim_observation_labmb=true,satu_sehat_kirim_diagnosticreport_lab=true,satu_sehat_kirim_diagnosticreport_labmb=true,
            kepatuhan_kelengkapan_keselamatan_bedah=true,nilai_piutang_perjenis_bayar_per_bulan=true,ringkasan_piutang_jenis_bayar=true,penilaian_pasien_imunitas_rendah=true,
            balance_cairan=true,catatan_observasi_chbp=true,catatan_observasi_induksi_persalinan=true,skp_kategori_penilaian=true,skp_kriteria_penilaian=true,
            skp_penilaian=true,referensi_poli_mobilejknfktp=true,referensi_dokter_mobilejknfktp=true,skp_rekapitulasi_penilaian=true,pembayaran_pihak_ke3_bankmandiri=true,
            metode_pembayaran_bankmandiri=true,bank_tujuan_transfer_bankmandiri=true,kodetransaksi_tujuan_transfer_bankmandiri=true,konsultasi_medik=true,jawaban_konsultasi_medik=true,
            pcare_cek_alergi=true,pcare_cek_prognosa=true,data_sasaran_usiaproduktif=true,data_sasaran_usialansia=true,skrining_perilaku_merokok_sekolah_remaja=true,
            skrining_kekerasan_pada_perempuan=true,skrining_obesitas=true,skrining_risiko_kanker_payudara=true,skrining_risiko_kanker_paru=true,skrining_tbc=true,
            skrining_kesehatan_gigi_mulut_remaja=true,penilaian_awal_keperawatan_ranap_bayi=true,booking_mcu_perusahaan=true,catatan_observasi_restrain_nonfarma=true,
            catatan_observasi_ventilator=true,catatan_anestesi_sedasi=true,skrining_puma=true,satu_sehat_kirim_careplan=true,satu_sehat_kirim_medicationstatement=true,
            skrining_adiksi_nikotin=true,skrining_thalassemia=true,skrining_instrumen_sdq=true,skrining_instrumen_srq=true,checklist_pemberian_fibrinolitik=true,
            skrining_kanker_kolorektal=true,dapur_pemesanan=true,bayar_pesan_dapur=true,hutang_dapur=true,titip_faktur_dapur=true,validasi_tagihan_dapur=true,
            surat_pemesanan_dapur=true,pengajuan_barang_dapur=true,dapur_returbeli=true,hibah_dapur=true,ringkasan_penerimaan_dapur=true,ringkasan_pengajuan_dapur=true,
            ringkasan_pemesanan_dapur=true,ringkasan_returbeli_dapur=true,ringkasan_stokkeluar_dapur=true,dapur_stokkeluar_pertanggal=true,sirkulasi_dapur=true,
            sirkulasi_dapur2=true,verifikasi_penerimaan_dapur=true,nilai_penerimaan_vendor_dapur_perbulan=true,ringkasan_hutang_vendor_dapur=true,penilaian_psikologi_klinis=true,
            penilaian_awal_medis_ranap_neonatus=true,penilaian_derajat_dehidrasi=true;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.surat_keterangan_terbang=true;
                        ...
                        akses.fisioterapi=rs2.getBoolean("fisioterapi");
                        ...
                        akses.data_fisioterapi=rs2.getBoolean("data_fisioterapi");
                        ...
                        akses.surat_keterangan_terbang=rs2.getBoolean("surat_keterangan_terbang");
    ...
    public static void setLogOut(){
        ...
        akses.surat_keterangan_terbang=false;
    ...
    public static void setpenjualan_obattrue(){akses.penjualan_obat=true;} 
    ...
    public static boolean getfisioterapi(){return akses.fisioterapi;}
    ...
    public static void setutd_penyerahan_darahtrue(){akses.utd_penyerahan_darah=true;} 
    ...
    public static void setresep_doktertrue(){akses.resep_dokter=true;} 
    ...
    public static void setresep_obattrue(){akses.resep_obat=true;} 
    ...
    public static void setperiksalabtrue(){akses.periksa_lab=true;} 
    public static void setperiksalabpatrue(){akses.pemeriksaan_lab_pa=true;} 
    public static void setperiksalabmbtrue(){akses.pemeriksaan_lab_mb=true;} 
    public static void setpermintaanlabtrue(){akses.permintaan_lab=true;} 
    public static boolean getpermintaan_radiologi(){return akses.permintaan_radiologi;}
    public static void setperiksaradiologitrue(){akses.periksa_radiologi=true;} 
    public static void setpermintaanradiologitrue(){akses.permintaan_radiologi=true;} 
    ...
    public static boolean getdata_fisioterapi(){return akses.data_fisioterapi;}
    ...
    public static boolean getsurat_keterangan_terbang(){return akses.surat_keterangan_terbang;}
