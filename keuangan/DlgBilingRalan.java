...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnPj = new javax.swing.JMenuItem();
        ...
        WindowGantiPj = new javax.swing.JDialog();
        ...
        MnPj.setBackground(new java.awt.Color(255, 255, 254));
        MnPj.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPj.setForeground(new java.awt.Color(50, 50, 50));
        MnPj.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPj.setText("Ganti Penanggung Jawab");
        MnPj.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPj.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPj.setName("MnPj"); // NOI18N
        MnPj.setPreferredSize(new java.awt.Dimension(250, 25));
        MnPj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPjActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnPj);
        ...
        WindowGantiPj.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowGantiPj.setName("WindowGantiPj"); // NOI18N
        WindowGantiPj.setUndecorated(true);
        WindowGantiPj.setResizable(false);
        ...
        jLabel39.setText("Penanggung Jawab:");
        jLabel39.setName("jLabel39"); // NOI18N
        internalFrame8.add(jLabel39);
        jLabel39.setBounds(0, 32, 110, 23);
        ...
        internalFrame8.add(PenanggungJawab);
        PenanggungJawab.setBounds(119, 32, 270, 23);

        WindowGantiPj.getContentPane().add(internalFrame8, java.awt.BorderLayout.CENTER);
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void MnPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPjActionPerformed
        WindowGantiPj.setSize(630,80);
        WindowGantiPj.setLocationRelativeTo(internalFrame1);
        WindowGantiPj.setAlwaysOnTop(false);
        WindowGantiPj.setVisible(true);
    }//GEN-LAST:event_MnPjActionPerformed

    private void BtnCloseIn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCloseIn6ActionPerformed
        WindowGantiPj.dispose();
    ...
    */
    ...
    private javax.swing.JMenuItem MnPj;
    ...
    private javax.swing.JDialog WindowGantiPj;
