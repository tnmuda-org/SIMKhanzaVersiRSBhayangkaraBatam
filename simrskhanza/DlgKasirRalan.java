...
import rekammedis.RMDataFisioterapi;
import permintaan.DlgPermintaanLaboratorium;
import permintaan.DlgPermintaanPelayananInformasiObat;
import permintaan.DlgPermintaanRadiologi;
import permintaan.DlgPermintaanRanap;
import rekammedis.RMAsesmenUlangHemodialisis;
...
import rekammedis.RMPemberianTransfusiDarah;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "No Reg","Penanggung Jawab","Alamat P.J.","Hubungan P.J.",
            "Biaya Reg","Jenis Bayar","Status","No.Rawat","Tanggal",
            "Jam","Poli","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","NIK"}){
    ...
    private void initComponents() {
        ...
        MnRMHemodialisa = new javax.swing.JMenu();
        MnRMHemodialisa.setBackground(new java.awt.Color(255, 255, 254));
        MnRMHemodialisa.setForeground(new java.awt.Color(50, 50, 50));
        MnRMHemodialisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRMHemodialisa.setText("RM Hemodialisa");
        MnRMHemodialisa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRMHemodialisa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRMHemodialisa.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRMHemodialisa.setName("MnRMHemodialisa"); // NOI18N
        MnRMHemodialisa.setPreferredSize(new java.awt.Dimension(210, 26));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void ppResumeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResumeBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMDataFisioterapi resume=new RMDataFisioterapi(null,false);
                resume.isCek();
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
    ...
    */
    ...
    private javax.swing.JMenuItem MnDataOperasi,MnPenilaianPreInduksi,MnHasilPemeriksaanUSG,MnHasilPemeriksaanUSGUrologi,MnHasilPemeriksaanUSGGynecologi,MnHasilPemeriksaanEKG,MnSudahTerbitSEP,MnPenatalaksanaanTerapiOkupasi,MnHasilPemeriksaanUSGNeonatus,
                                  MnHasilEndoskopiFaringLaring,MnHasilEndoskopiHidung,MnHasilEndoskopiTelinga,MnPenilaianAwalKeperawatanHemodialisa,MnPemberianTransfusi,MnCetakKeteranganBerobat,MnCetakKeteranganDiagnosis,MnCetakSuratSakit2,MnTTV;
    ...
    private javax.swing.JMenu MnSuratSurat2,MnRMHemodialisa;
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        rskasir.getString(5),rskasir.getString(6),rskasir.getString(7),rskasir.getString(8)+" ("+rskasir.getString("jk")+")"+" ("+rskasir.getString("tgl_lahir")+")"+" ("+rskasir.getString("umur")+")",
                        rskasir.getString(1),rskasir.getString(10),rskasir.getString(11),rskasir.getString(12),Valid.SetAngka(rskasir.getDouble(13)),
                        rskasir.getString("png_jawab"),rskasir.getString(14),rskasir.getString("no_rawat"),rskasir.getString("tgl_registrasi"),
                        rskasir.getString("jam_reg"),rskasir.getString(9),rskasir.getString("status_bayar"),rskasir.getString("status_poli"),
    ...
    private void getDatakasir() {
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            digit.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),4).toString());
   ...
   //     MnCatatanObservasiCHBP.setEnabled(akses.getcatatan_observasi_chbp());
    ...
    //    MnPenilaianPsikologKlinis.setEnabled(akses.getpenilaian_psikologi_klinis());
        ...
        MnPemberianTransfusi.setEnabled(akses.getmonitoring_reaksi_tranfusi());
    ...
    private void initKasirRalan() {
        ...
        MnPemberianTransfusi = new javax.swing.JMenuItem();
        MnPemberianTransfusi.setBackground(new java.awt.Color(255, 255, 254));
        MnPemberianTransfusi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPemberianTransfusi.setForeground(new java.awt.Color(50, 50, 50));
        MnPemberianTransfusi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPemberianTransfusi.setText("Pemberian Transfusi Darah");
        MnPemberianTransfusi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPemberianTransfusi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPemberianTransfusi.setName("MnPemberianTransfusi"); // NOI18N
        MnPemberianTransfusi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnPemberianTransfusi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPemberianTransfusiActionPerformed(evt);
            }
        });
        ...
        MnRMCatatanMonitoring.add(MnPemberianTransfusi);
        ...
        MnTTV = new javax.swing.JMenuItem();

        MnTTV.setBackground(new java.awt.Color(255, 255, 254));
        MnTTV.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTV.setForeground(new java.awt.Color(50, 50, 50));
        MnTTV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTV.setText("TTV");
        MnTTV.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTTV.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTTV.setName("MnTTV"); // NOI18N
        MnTTV.setPreferredSize(new java.awt.Dimension(180, 26));
        MnTTV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTVActionPerformed(evt);
            }
        });
        MnStatus.add(MnTTV);
    ...
    private void MnPenilaianAwalKeperawatanHemodialisaActionPerformed(java.awt.event.ActionEvent evt) {                                                                      
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    private void MnPemberianTransfusiActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPemberianTransfusiDarah form=new RMPemberianTransfusiDarah(null,false);
                form.isCek();
                form.emptTeks();
                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                form.tampil();
    ...
    private void MnCetakKeteranganDiagnosisActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
    ...
    private void MnCetakKeteranganBerobatActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
    ...
    private void MnCetakSuratSakit2ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        if(tabModekasir2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
        }else if(TPasienCari.getText().trim().equals("")){
    ...
    private void MnTTVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTVActionPerformed
       if(TNoRw.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"No.Rawat");
        }else{
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='TTV'");
                if(tbKasirRalan.getSelectedRow()>-1){
