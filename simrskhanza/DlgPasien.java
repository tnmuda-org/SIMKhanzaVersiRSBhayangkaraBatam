...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppCatatanAlergiPasien = new javax.swing.JMenuItem();
        ...
        ppCatatanAlergiPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCatatanAlergiPasien.setForeground(new java.awt.Color(50, 50, 50));
        ppCatatanAlergiPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCatatanAlergiPasien.setText("Catatan Alergi Pasien");
        ppCatatanAlergiPasien.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCatatanAlergiPasien.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCatatanAlergiPasien.setName("ppCatatanAlergiPasien"); // NOI18N
        ppCatatanAlergiPasien.setPreferredSize(new java.awt.Dimension(220, 26));
        ppCatatanAlergiPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCatatanAlergiPasienBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppCatatanAlergiPasien);
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-06-2023" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-06-2023" }));
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void ppCatatanAlergiPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCatatanAlergiPasienBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNo.requestFocus();
        }else if(TNm.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgCatatanAlergi catatan=new DlgCatatanAlergi(null,true);
            catatan.setNoRm(TNo.getText());
            catatan.setSize(720,330);
            catatan.setLocationRelativeTo(internalFrame1);
            catatan.setVisible(true);
    ...
    }//GEN-LAST:event_ppCatatanAlergiPasienBtnPrintActionPerformed
    ...
    private javax.swing.JMenuItem ppCatatanAlergiPasien;
