...
public final class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel13.setBounds(220, 40, 55, 23);

        jLabel14.setText("Diagnosa  :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(570, 10, 60, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-01-2026" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(280, 40, 90, 23);

        jLabel5.setText("Saran Dokter :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(380, 40, 90, 23);
        ...
        Keperluan.setBounds(480, 40, 630, 23);
        ...
        Keluhan.setBounds(640, 10, 470, 23);
    ...
    private void MnCetakSuratKewaspadaanKesehatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKewaspadaanKesehatanActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("finger","http://36.88.127.106:7500/verify/?id="+EnkripsiAES.encrypt("{'x':'skb','t':'"+NoSurat.getText()+"'}"));
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
    ...
    */
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_kewaspadaan_kesehatan.no_surat,3),signed)),0) from surat_kewaspadaan_kesehatan where surat_kewaspadaan_kesehatan.tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
                "SKB"+TanggalPeriksa.getSelectedItem().toString().substring(6,10)+TanggalPeriksa.getSelectedItem().toString().substring(3,5)+TanggalPeriksa.getSelectedItem().toString().substring(0,2),3,NoSurat); 
