...
public final class SuratKeteranganBerobat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Berobat UGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_keterangan_berobat","?,?,?,?,?,?,?","No.Surat Berobat",7,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_keterangan_berobat","no_surat");
        tampil();
        emptTeks();
  ...
  if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_berobat","no_surat=?","no_surat=?,no_rawat=?,kd_dokter=?,namadokter=?,tanggalawal=?,tanggalakhir=?,mberlaku=?",8,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            tgl=" surat_keterangan_berobat.tanggalawal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKeteranganBerobat.jasper","report","::[ Data Surat Keterangan Diagnosis ]::",
                     "select surat_keterangan_berobat.no_surat,surat_keterangan_berobat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat.tanggalawal,surat_keterangan_berobat.tanggalakhir,surat_keterangan_berobat.mberlaku,concat(surat_keterangan_berobat.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     ...
                     "inner join dokter on surat_keterangan_berobat.kd_dokter=dokter.kd_dokter "+        
                     "where "+tgl+"order by surat_keterangan_berobat.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratKeteranganBerobat.jasper","report","::[ Data Surat Keterangan Dagnosis ]::",
                     "select surat_keterangan_berobat.no_surat,surat_keterangan_berobat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat.tanggalawal,surat_keterangan_berobat.tanggalakhir,surat_keterangan_berobat.mberlaku,concat(surat_keterangan_berobat.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     "from surat_keterangan_berobat inner join reg_periksa on surat_keterangan_berobat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     ...
                     tgl+"and surat_keterangan_berobat.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
    ...
    private void MnCetakSuratKeteranganBerobatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKeteranganBerobatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());  
                kodedokter=Sequel.cariIsi("select surat_keterangan_berobat.kd_dokter from surat_keterangan_berobat where surat_keterangan_berobat.no_rawat=?",TNoRw.getText());
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_berobat.no_surat,surat_keterangan_berobat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat.tanggalawal,surat_keterangan_berobat.tanggalakhir,surat_keterangan_berobat.mberlaku,surat_keterangan_berobat.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_keterangan_berobat inner join reg_periksa on surat_keterangan_berobat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_keterangan_berobat.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_keterangan_berobat.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_berobat.no_surat,surat_keterangan_berobat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat.tanggalawal,surat_keterangan_berobat.tanggalakhir,surat_keterangan_berobat.mberlaku,surat_keterangan_berobat.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     "inner join dokter on surat_keterangan_berobat.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                     ...
                     tgl+"and surat_keterangan_berobat.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_keterangan_berobat.no_surat");
            }
    ...
    private void nomorSurat() {
        ...
        Valid.autoNomerSuratKhusus1("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0), MONTH(tanggalawal) bln from surat_keterangan_berobat where "
                + "tanggalawal like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%' ", "/SKO"+"/RJ/" + bln_romawi + "/" + TanggalAwal.getSelectedItem().toString().substring(6,10), 3, NoSurat);
        bln_angka = Sequel.cariIsi("SELECT MONTH(tanggalawal) bln FROM surat_keterangan_berobat WHERE tanggalawal like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%'");
    }
}
