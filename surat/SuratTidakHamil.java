...
public final class SuratTidakHamil extends javax.swing.JDialog {
    ...
    public SuratTidakHamil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tgl.Periksa","Hasil Pemeriksaan","Diagnosa","Tensi Tubuh","Suhu","Nadi","Respirasi","Kode Dokter","Nm Dokter"
        }){
        ...
        Respirasi.setDocument(new batasInput((byte)4).getKata(Respirasi));
    ...
    private void initComponents() {
        ...
        MnCetakSuratHamil.setText("Cetak Surat Keterangan Kelayakan Terbang");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Kelayakan Terbang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel13.setBounds(1080, 10, 65, 23);

        HasilPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Diperbolehkan", "Tidak Diperbolehkan" }));
        HasilPeriksa.setName("HasilPeriksa"); // NOI18N
        FormInput.add(HasilPeriksa);
        HasilPeriksa.setBounds(1150, 40, 150, 23);

        jLabel14.setText("Hasil Periksa :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(1070, 40, 77, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2023" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(1150, 10, 90, 23);

        jLabel5.setText("Diagnosa : ");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(220, 40, 60, 23);
        ...
        Keluhan.setBounds(290, 40, 430, 23);
        ...
        FormInput.add(Tensi);
        Tensi.setBounds(770, 10, 60, 23);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("°C");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(840, 40, 40, 23);
        ...
        Respirasi.setBounds(940, 40, 60, 23);

        jLabel9.setText("Respirasi : ");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(880, 40, 60, 23);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel10.setText("Suhu : ");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(730, 40, 50, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(770, 40, 60, 23);

        jLabel11.setText("Nadi : ");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(880, 10, 60, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(940, 10, 60, 23);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("Tensi : ");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(730, 10, 50, 23);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("x/Menit");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(1010, 40, 40, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("mmHg");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(840, 10, 40, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("x/Menit");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(1010, 10, 40, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_hamil","?,?,?,?,?,?,?,?,?","No.Surat",9,new String[]{
                NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),HasilPeriksa.getSelectedItem()+"",
                Keluhan.getText(),Tensi.getText(),Suhu.getText(),Nadi.getText(),Respirasi.getText()
            })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                ...
                "no_surat=?,no_rawat=?,tanggalperiksa=?,hasilperiksa=?,keluhan=?,tensi=?,suhu=?,nadi=?,respirasi=?",10,new String[]{
                
                    NoSurat.getText(),
                    TNoRw.getText(),
                    Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),
                    HasilPeriksa.getSelectedItem()+"",
                    Keluhan.getText(),
                    Tensi.getText(),
                    Suhu.getText(),
                    Nadi.getText(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratHamil.jasper","report","::[ Data Surat Keterangan Kelayakan Terbang]::",
    ...
    private void MnCetakSuratHamilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratHamilActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());    
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) "+
                "from sidikjari inner join pegawai on pegawai.id=sidikjari.id "+
                "where pegawai.id=?",tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
//              param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),6).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()));  
                param.put("finger","http://36.88.127.106:7500/verify/?id="+EnkripsiAES.encrypt("{'x':'skkt','t':'"+NoSurat.getText()+"'}"));
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptSuratTidakHamil.jasper","report","::[ Surat Keterangan Kelayakan Terbang ]::",
                              ...
                              " pasien.nm_pasien,surat_hamil.keluhan,surat_hamil.tensi,surat_hamil.suhu,surat_hamil.nadi,surat_hamil.respirasi,dokter.no_ijn_praktek,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_hamil.no_surat,surat_hamil.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_hamil.tanggalperiksa,surat_hamil.hasilperiksa,surat_hamil.keluhan,surat_hamil.tensi,surat_hamil.suhu,surat_hamil.nadi,surat_hamil.respirasi,reg_periksa.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_hamil inner join reg_periksa on surat_hamil.no_rawat=reg_periksa.no_rawat "+
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_hamil.no_surat,3),signed)),0) from surat_hamil where surat_hamil.tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
                "SKKT/"+TanggalPeriksa.getSelectedItem().toString().substring(6,10)+TanggalPeriksa.getSelectedItem().toString().substring(3,5)+TanggalPeriksa.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Keluhan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
            ...
            Respirasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
        }
    }
