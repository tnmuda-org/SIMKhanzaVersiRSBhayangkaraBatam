 ...
 * @author salimmulyana
 */
public final class SuratKeteranganBerobatUgd extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKeteranganBerobatUgd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnCetakSuratKeteranganBerobat.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratKeteranganBerobat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratKeteranganBerobat.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratKeteranganBerobat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKeteranganBerobat.setText("Surat Keterangan Brobat");
        MnCetakSuratKeteranganBerobat.setName("MnCetakSuratKeteranganBerobat"); // NOI18N
        MnCetakSuratKeteranganBerobat.setPreferredSize(new java.awt.Dimension(200, 26));
        MnCetakSuratKeteranganBerobat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratKeteranganBerobatActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratKeteranganBerobat);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Berobat UGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2022" }));
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2022" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-08-2022" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_keterangan_berobat_ugd","?,?,?,?,?,?,?","No.Surat Berobat",7,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_keterangan_berobat_ugd","no_surat");
        tampil();
        emptTeks();
  ...
  if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_berobat_ugd","no_surat=?","no_surat=?,no_rawat=?,kd_dokter=?,namadokter=?,tanggalawal=?,tanggalakhir=?,mberlaku=?",8,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            tgl=" surat_keterangan_berobat_ugd.tanggalawal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKeteranganBerobatUGD.jasper","report","::[ Data Surat Keterangan Diagnosis ]::",
                     "select surat_keterangan_berobat_ugd.no_surat,surat_keterangan_berobat_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat_ugd.tanggalawal,surat_keterangan_berobat_ugd.tanggalakhir,surat_keterangan_berobat_ugd.mberlaku,concat(surat_keterangan_berobat_ugd.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     "from surat_keterangan_berobat_ugd inner join reg_periksa on surat_keterangan_berobat_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_keterangan_berobat_ugd.kd_dokter=dokter.kd_dokter "+        
                     "where "+tgl+"order by surat_keterangan_berobat_ugd.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratKeteranganBerobatUGD.jasper","report","::[ Data Surat Keterangan Dagnosis ]::",
                     "select surat_keterangan_berobat_ugd.no_surat,surat_keterangan_berobat_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat_ugd.tanggalawal,surat_keterangan_berobat_ugd.tanggalakhir,surat_keterangan_berobat_ugd.mberlaku,concat(surat_keterangan_berobat_ugd.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     "from surat_keterangan_berobat_ugd inner join reg_periksa on surat_keterangan_berobat_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     ...
                     tgl+"and surat_keterangan_berobat_ugd.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat_ugd.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat_ugd.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_keterangan_berobat_ugd.no_surat",param);
            }
    ...
    private void MnCetakSuratKeteranganBerobatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKeteranganBerobatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());  
               kodedokter=Sequel.cariIsi("select surat_keterangan_berobat_ugd.kd_dokter from surat_keterangan_berobat_ugd where surat_keterangan_berobat_ugd.no_rawat=?",TNoRw.getText());
                ...
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSuratKeteranganBerobat.jasper","report","::[ Surat Sakit ]::",
    ...
    }//GEN-LAST:event_MnCetakSuratKeteranganBerobatActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganBerobatUgd dialog = new SuratKeteranganBerobatUgd(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnCetakSuratKeteranganBerobat;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_berobat_ugd.no_surat,surat_keterangan_berobat_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat_ugd.tanggalawal,surat_keterangan_berobat_ugd.tanggalakhir,surat_keterangan_berobat_ugd.mberlaku,surat_keterangan_berobat_ugd.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_keterangan_berobat_ugd inner join reg_periksa on surat_keterangan_berobat_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_keterangan_berobat_ugd.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_keterangan_berobat_ugd.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_berobat_ugd.no_surat,surat_keterangan_berobat_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_berobat_ugd.tanggalawal,surat_keterangan_berobat_ugd.tanggalakhir,surat_keterangan_berobat_ugd.mberlaku,surat_keterangan_berobat_ugd.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     "inner join dokter on surat_keterangan_berobat_ugd.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat_ugd.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                     ...
                     tgl+"and surat_keterangan_berobat_ugd.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_berobat_ugd.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_keterangan_berobat_ugd.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        nomorSurat();        
            //Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_keterangan_berobat_ugd where tanggalawal='"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"")+"' ",
                //"SKO"+"/UGD/"+TanggalAwal.getSelectedItem().toString().substring(0,2)+"/"+TanggalAwal.getSelectedItem().toString().substring(3,5)+"/"+TanggalAwal.getSelectedItem().toString().substring(6,10)+"/",3,NoSurat); 
    ...
    private void nomorSurat() {
        ...
        Valid.autoNomerSuratKhusus1("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0), MONTH(tanggalawal) bln from surat_keterangan_berobat_ugd where "
                + "tanggalawal like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%' ", "/SKO"+"/UGD/" + bln_romawi + "/" + TanggalAwal.getSelectedItem().toString().substring(6,10), 3, NoSurat);
        bln_angka = Sequel.cariIsi("SELECT MONTH(tanggalawal) bln FROM surat_keterangan_berobat_ugd WHERE tanggalawal like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%'");
    }
}
