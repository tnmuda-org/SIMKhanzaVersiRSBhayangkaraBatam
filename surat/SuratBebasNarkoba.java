...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(420, 70, 70, 23);
        ...
        NoSurat.setBounds(500, 70, 330, 23);
        ...
        TPasien.setBounds(332, 10, 510, 23);
        ...
        jLabel18.setBounds(710, 130, 100, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-01-2025" }));
        ...
        TanggalSurat.setBounds(810, 100, 90, 23);

        jLabel13.setText("Tanggal Surat :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(710, 100, 90, 23);
        ...
        Keperluan.setBounds(90, 40, 750, 23);
        ...
        jLabel22.setBounds(20, 40, 63, 23);
        ...
        Kategori.setBounds(820, 130, 100, 23);
    ...
    private void MnCetakSuratSKBNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSKBNActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("finger","http://36.88.127.106:7500/verify/?id="+EnkripsiAES.encrypt("{'x':'skbn','t':'"+NoSurat.getText()+"'}"));
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptBebasNarkoba1.jasper","report","::[ Surat SKBN 1 ]::",
                            ...
                            " perusahaan_pasien.nama_perusahaan, pasien.keluarga, pasien.namakeluarga, " +
                            " pasien.tgl_lahir, CONCAT(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) AS umur, " +
                            " pasien.tmp_lahir, pasien.agama, pasien.nm_pasien, pasien.jk, pasien.pekerjaan, " +
                            " CONCAT(pasien.alamat, ', ', kelurahan.nm_kel, ', ', kecamatan.nm_kec, ', ', kabupaten.nm_kab) AS alamat, " +
                            " suku_bangsa.nama_suku_bangsa, reg_periksa.kd_dokter, dokter.no_ijn_praktek " +
                            " FROM reg_periksa " +
                            " INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
