 ...
 * @author salimmulyana
 */
public final class SuratKeteranganDiagnosisUgd extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKeteranganDiagnosisUgd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Diagnosis UGD]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Fira Sans", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_keterangan_diagnosa_ugd","?,?,?,?,?,?,?","No.Surat Diagnosis",7,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_keterangan_diagnosa_ugd","no_surat");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_diagnosa_ugd","no_surat=?","no_surat=?,no_rawat=?,kd_dokter=?,namadokter=?,tanggalawal=?,tanggalakhir=?,mberlaku=?",8,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            tgl=" surat_keterangan_diagnosa_ugd.tanggalawal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKeteranganDiagnosisUGD.jasper","report","::[ Data Surat Keterangan Diagnosis ]::",
                     "select surat_keterangan_diagnosa_ugd.no_surat,surat_keterangan_diagnosa_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_diagnosa_ugd.tanggalawal,surat_keterangan_diagnosa_ugd.tanggalakhir,surat_keterangan_diagnosa_ugd.mberlaku,concat(surat_keterangan_diagnosa_ugd.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     "from surat_keterangan_diagnosa_ugd inner join reg_periksa on surat_keterangan_diagnosa_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_keterangan_diagnosa_ugd.kd_dokter=dokter.kd_dokter "+
                     "where "+tgl+"order by surat_keterangan_diagnosa_ugd.no_surat",param);
            }else{
                Valid.MyReportqry("rptDataSuratKeteranganDiagnosisUGD.jasper","report","::[ Data Surat Keterangan Dagnosis ]::",
                     "select surat_keterangan_diagnosa_ugd.no_surat,surat_keterangan_diagnosa_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_diagnosa_ugd.tanggalawal,surat_keterangan_diagnosa_ugd.tanggalakhir,surat_keterangan_diagnosa_ugd.mberlaku,concat(surat_keterangan_diagnosa_ugd.kd_dokter,' ',dokter.nm_dokter)as namadokter "+                  
                     "from surat_keterangan_diagnosa_ugd inner join reg_periksa on surat_keterangan_diagnosa_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     ...
                     tgl+"and surat_keterangan_diagnosa_ugd.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and dokter.nm_dokter like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_diagnosa_ugd.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_diagnosa_ugd.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_diagnosa_ugd.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_keterangan_diagnosa_ugd.no_surat",param);
            }
    ...
    private void MnCetakSuratKeteranganDiagnosisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKeteranganDiagnosisActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());  
                kodedokter=Sequel.cariIsi("select surat_keterangan_diagnosa_ugd.kd_dokter from surat_keterangan_diagnosa_ugd where surat_keterangan_diagnosa_ugd.no_rawat=?",TNoRw.getText());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganDiagnosisUgd dialog = new SuratKeteranganDiagnosisUgd(new javax.swing.JFrame(), true);
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_diagnosa_ugd.no_surat,surat_keterangan_diagnosa_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_diagnosa_ugd.tanggalawal,surat_keterangan_diagnosa_ugd.tanggalakhir,surat_keterangan_diagnosa_ugd.mberlaku,surat_keterangan_diagnosa_ugd.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_keterangan_diagnosa_ugd inner join reg_periksa on surat_keterangan_diagnosa_ugd.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_keterangan_diagnosa_ugd.kd_dokter=dokter.kd_dokter "+        
                     "where "+tgl+"order by surat_keterangan_diagnosa_ugd.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_diagnosa_ugd.no_surat,surat_keterangan_diagnosa_ugd.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_diagnosa_ugd.tanggalawal,surat_keterangan_diagnosa_ugd.tanggalakhir,surat_keterangan_diagnosa_ugd.mberlaku,surat_keterangan_diagnosa_ugd.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     tgl+"and surat_keterangan_diagnosa_ugd.tanggalawal like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_keterangan_diagnosa_ugd.tanggalakhir like '%"+TCari.getText().trim()+"%' "+
                     "order by surat_keterangan_diagnosa_ugd.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        nomorSurat();
        //Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_keterangan_diagnosa_ugd where tanggalawal='"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"")+"' ",
    ...
    private void nomorSurat() {
        ...
        Valid.autoNomerSuratKhusus1("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0), MONTH(tanggalawal) bln from surat_keterangan_diagnosa_ugd where "
        ...
        bln_angka = Sequel.cariIsi("SELECT MONTH(tanggalawal) bln FROM surat_keterangan_diagnosa_ugd WHERE tanggalawal like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%'");
    }
}
