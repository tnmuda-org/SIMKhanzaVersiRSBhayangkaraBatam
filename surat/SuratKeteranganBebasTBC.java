...
public final class SuratKeteranganBebasTBC extends javax.swing.JDialog {
    ...
    public SuratKeteranganBebasTBC(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tanggal Surat","Tanggal Awal","Tanggal Akhir","Kode Dokter","Dokter Rawat Inap","Diagnosa Pasien"
        }){
    ...
    private void initComponents() {
        ...
        Tanggal_Awal = new widget.Tanggal();
        Tanggal_Akhir = new widget.Tanggal();
        ...
        MnCetakSuratBebasTBC.setText("Print Surat Sakit");
        ...
        jLabel3.setBounds(450, 70, 60, 23);
        ...
        TPasien.setBounds(335, 10, 410, 23);
        ...
        Keperluan.setBounds(515, 70, 230, 23);
        ...
        TanggalSurat.setBounds(324, 40, 90, 23);

        jLabel16.setText("Tanggal Surat  :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(230, 40, 90, 23);
        ...
        TDokter.setBounds(179, 70, 230, 23);
        ...
        btnDokter.setBounds(410, 72, 28, 23);

        jLabel17.setText("Tanggal :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(410, 40, 60, 23);

        Tanggal_Awal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal_Awal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2026" }));
        Tanggal_Awal.setDisplayFormat("dd-MM-yyyy");
        Tanggal_Awal.setName("Tanggal_Awal"); // NOI18N
        Tanggal_Awal.setOpaque(false);
        Tanggal_Awal.setPreferredSize(new java.awt.Dimension(141, 18));
        Tanggal_Awal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tanggal_AwalActionPerformed(evt);
            }
        });
        Tanggal_Awal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Tanggal_AwalKeyPressed(evt);
            }
        });
        FormInput.add(Tanggal_Awal);
        Tanggal_Awal.setBounds(470, 40, 90, 23);

        Tanggal_Akhir.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal_Akhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2026" }));
        Tanggal_Akhir.setDisplayFormat("dd-MM-yyyy");
        Tanggal_Akhir.setName("Tanggal_Akhir"); // NOI18N
        Tanggal_Akhir.setOpaque(false);
        Tanggal_Akhir.setPreferredSize(new java.awt.Dimension(141, 18));
        Tanggal_Akhir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tanggal_AkhirActionPerformed(evt);
            }
        });
        Tanggal_Akhir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Tanggal_AkhirKeyPressed(evt);
            }
        });
        FormInput.add(Tanggal_Akhir);
        Tanggal_Akhir.setBounds(590, 40, 90, 23);

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel18.setText("s.d.");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(560, 40, 30, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_bebas_tbc","?,?,?,?,?,?,?","No.Surat",7,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Valid.SetTgl(Tanggal_Awal.getSelectedItem()+""),Valid.SetTgl(Tanggal_Akhir.getSelectedItem()+""),KdDok.getText(),Keperluan.getText()
                })==true){
                tabMode.addRow(new String[]{
                    NoSurat.getText(),TNoRw.getText(),TNoRM.getText(),TPasien.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Valid.SetTgl(Tanggal_Awal.getSelectedItem()+""),Valid.SetTgl(Tanggal_Akhir.getSelectedItem()+""),KdDok.getText(),TDokter.getText(),Keperluan.getText()
                });
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Tanggal_Awal,BtnBatal);
            Valid.pindah(evt,Tanggal_Akhir,BtnBatal);
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_bebas_tbc","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,tanggal_awal=?,tanggal_akhir=?,kd_dokter=?,keperluan=?",8,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Valid.SetTgl(Tanggal_Awal.getSelectedItem()+""),Valid.SetTgl(Tanggal_Akhir.getSelectedItem()+""),KdDok.getText(),Keperluan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    ...
                    tbObat.setValueAt(Valid.SetTgl(Tanggal_Awal.getSelectedItem()+""),tbObat.getSelectedRow(),5);
                    tbObat.setValueAt(Valid.SetTgl(Tanggal_Akhir.getSelectedItem()+""),tbObat.getSelectedRow(),6);
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratBebasTBC.jasper","report","::[ Data Surat Bebas TBC ]::",
                        "SELECT surat_bebas_tbc.no_surat, " +
                        "DATE_FORMAT(surat_bebas_tbc.tanggalsurat,'%d-%m-%Y') AS tanggal_surat, " +
                        "DATE_FORMAT(surat_bebas_tbc.tanggal_awal,'%d-%m-%Y') AS tanggal_awal, " +
                        "DATE_FORMAT(surat_bebas_tbc.tanggal_akhir,'%d-%m-%Y') AS tanggal_akhir, " +
                        "surat_bebas_tbc.keperluan, pasien.jk, pasien.nm_pasien, " +
                        "dokter.nm_dokter AS nm_dokter, " +
                        "DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') AS tgl_lahir, " +
                        "pasien.tmp_lahir, pasien.pekerjaan, " +
                        "CONCAT(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) AS alamat " +
                        "FROM surat_bebas_tbc " +
                        "INNER JOIN reg_periksa ON reg_periksa.no_rawat = surat_bebas_tbc.no_rawat " +
                        "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                        "INNER JOIN dokter ON surat_bebas_tbc.kd_dokter = dokter.kd_dokter " +
                        "INNER JOIN kelurahan ON pasien.kd_kel = kelurahan.kd_kel " +
                        "INNER JOIN kecamatan ON pasien.kd_kec = kecamatan.kd_kec " +
                        "INNER JOIN kabupaten ON pasien.kd_kab = kabupaten.kd_kab " +
                        "WHERE surat_bebas_tbc.no_surat = '"+TNoSurat.getText()+"'",
                                                                        param
                                                                    );
            }else{
                Valid.MyReportqry("rptDataSuratBebasTBC.jasper","report","::[ Data Surat Bebas TBC ]::",
    ...
    private void MnCetakSuratBebasTBCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratBebasTBCActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("finger","http://36.88.127.106:7500/verify/?id="+EnkripsiAES.encrypt("{'x':'skis','t':'"+NoSurat.getText()+"'}"));
                ...
                Valid.MyReportqry("rptSuratKeteranganBebasTBC.jasper","report","::[ Surat Keterangan Bebas TBC ]::",
                                ...
                                "DATE_FORMAT(surat_bebas_tbc.tanggal_awal,'%d-%m-%Y') AS tanggal_awal, " +
                                "DATE_FORMAT(surat_bebas_tbc.tanggal_akhir,'%d-%m-%Y') AS tanggal_akhir, " +
                                "surat_bebas_tbc.keperluan, dokter.nm_dokter, pasien.jk, " +
                                "pasien.nm_pasien, " +
                                "DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') AS tgl_lahir, " +
                                "pasien.tmp_lahir, pasien.pekerjaan, dokter.kd_dokter, " +
                                "CONCAT(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) AS alamat " +
                                "FROM surat_bebas_tbc " +
                                "INNER JOIN reg_periksa ON reg_periksa.no_rawat = surat_bebas_tbc.no_rawat " +
                                "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
    ...
    private void Tanggal_AwalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tanggal_AwalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tanggal_AwalActionPerformed

    private void Tanggal_AwalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tanggal_AwalKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tanggal_AwalKeyPressed

    private void Tanggal_AkhirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tanggal_AkhirActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tanggal_AkhirActionPerformed

    private void Tanggal_AkhirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tanggal_AkhirKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tanggal_AkhirKeyPressed
    ...
    */
    ...
    private widget.Tanggal Tanggal_Akhir;
    private widget.Tanggal Tanggal_Awal;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_bebas_tbc.no_surat,surat_bebas_tbc.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_bebas_tbc.tanggalsurat,surat_bebas_tbc.tanggal_awal,surat_bebas_tbc.tanggal_akhir,surat_bebas_tbc.kd_dokter,dokter.nm_dokter,surat_bebas_tbc.keperluan "+                   
                     "from surat_bebas_tbc inner join reg_periksa on surat_bebas_tbc.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_bebas_tbc.kd_dokter=dokter.kd_dokter "+
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_bebas_tbc.no_surat,3),signed)),0) from surat_bebas_tbc where surat_bebas_tbc.tanggalsurat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ",
                "SKS-RI/"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),3,NoSurat);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Valid.SetTgl(Tanggal_Awal,tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
            Valid.SetTgl(Tanggal_Akhir,tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
