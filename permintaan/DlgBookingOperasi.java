...
import rekammedis.RMLaporanAnastesi;
...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnInstrumen1 = new widget.Button();
        ...
        BtnInstrumen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInstrumen1.setText("Laporan Anestesi");
        BtnInstrumen1.setFocusPainted(false);
        BtnInstrumen1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInstrumen1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInstrumen1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInstrumen1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInstrumen1.setName("BtnInstrumen1"); // NOI18N
        BtnInstrumen1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInstrumen1.setRoundRect(false);
        BtnInstrumen1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInstrumen1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInstrumen1);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnInstrumen1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInstrumen1ActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
            if(tbObat.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMLaporanAnastesi form=new RMLaporanAnastesi(null,false);
                form.isCek();
                form.emptTeks();
                form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    }//GEN-LAST:event_BtnInstrumen1ActionPerformed
    ...
    */
    ...
    private widget.Button BtnInstrumen1;
