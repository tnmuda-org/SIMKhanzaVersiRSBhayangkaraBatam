...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{
                ...
                "Jam","Kode Dokter","Dokter Perujuk","Poli Registrasi","Informasi Tambahan","Diagnosis Klinis","Kode Bayar","Jenis Bayar","NIK"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
            ...
            "Dokter Perujuk","Kamar Terakhir","Informasi Tambahan","Diagnosis Klinis","Kode Bayar","Jenis Bayar","NIK"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                            ...
                            "poliklinik.nm_poli,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,pasien.no_ktp "+
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                koneksisysmex.prepareStatement(
                                        ...
                                        "'"+Permintaan+"','0','"+rs.getString("no_ktp")+"')").executeUpdate();
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                            ...
                            "permintaan_lab.dokter_perujuk,dokter.nm_dokter,kamar_inap.kd_kamar,bangsal.kd_bangsal,bangsal.nm_bangsal,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,pasien.no_ktp "+
                            "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                            "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "permintaan_lab.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,pasien.no_ktp "+
                    "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("no_ktp")
                    });
                    ps2=koneksi.prepareStatement(
                            "select permintaan_pemeriksaan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan "+
                            "from permintaan_pemeriksaan_lab inner join jns_perawatan_lab on "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode2.addRow(new String[]{
                        ...
                        rs.getString("diagnosa_klinis"),rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("no_ktp")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                    ...
                    "if(permintaan_lab.tgl_sampel='0000-00-00','',permintaan_lab.tgl_sampel) as tgl_sampel,if(permintaan_lab.jam_sampel='00:00:00','',permintaan_lab.jam_sampel) as jam_sampel,"+
                    "if(permintaan_lab.tgl_hasil='0000-00-00','',permintaan_lab.tgl_hasil) as tgl_hasil,if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,"+
                    "permintaan_lab.dokter_perujuk,dokter.nm_dokter,ifnull(bangsal.nm_bangsal,'Ranap Gabung') as nm_bangsal,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis,pasien.no_ktp "+
                    "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter "+
