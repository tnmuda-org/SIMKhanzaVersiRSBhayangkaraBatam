...
public final class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Dokter Jaga","Tanggal Kunjungan"}){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Dokter Jaga","Tanggal Kunjungan"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        try {            
            ...
            switch (pilihan) {
                case "Laporan 1 (HTML)":
                        ...
                        htmlContent.append(                             
                            "<tr class='isi'>"+
                                ...
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Tanggal Kunjungan</b></td>"+
                            "</tr>"
                        ); 
                ...
                case "Laporan 3 (CSV)":
                        htmlContent = new StringBuilder();
                        htmlContent.append(                             
                            "\"No.\";\"Lama\";\"Baru\";\"Nama Pasien\";\"L\";\"P\";\"Alamat\";\"Kode\";\"Diagnosa\";\"Dokter Jaga\";\"Tanggal Kunjungan\"\n"
                        ); 
                        if(TabRawat.getSelectedIndex()==0){
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
                            ...
                            for(i=0;i<tabMode2.getRowCount();i++){  
                                htmlContent.append(                             
                                    "\""+tabMode2.getValueAt(i,0)+"\";\""+tabMode2.getValueAt(i,1)+"\";\""+tabMode2.getValueAt(i,2)+"\";\""+tabMode2.getValueAt(i,3)+"\";\""+tabMode2.getValueAt(i,4)+"\";\""+tabMode2.getValueAt(i,5)+"\";\""+tabMode2.getValueAt(i,6)+"\";\""+tabMode2.getValueAt(i,7)+"\";\""+tabMode2.getValueAt(i,8)+"\";\""+tabMode.getValueAt(i,9)+"\";\""+tabMode.getValueAt(i,10)+"\"\n"
                                ); 
                            } 
                        }         
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,reg_periksa.stts_daftar," +
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("almt_pj"),kddiangnosa,diagnosa,rs.getString("nm_dokter"),rs.getString("tgl_registrasi")
                    });                
                    i++;
                }
                if(i>=2){
